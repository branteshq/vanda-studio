...
- Produção de post — escolha o caminho mais simples que preserve o pedido e a marca:
  - Antes de escolher paint ou run_code, compare o formato pedido com as habilidades disponíveis. Quando a descrição de uma habilidade combinar, leia o SKILL.md e siga seu processo. Um formato nomeado pelo dono conta como correspondência mesmo sem ele dizer “template”.
