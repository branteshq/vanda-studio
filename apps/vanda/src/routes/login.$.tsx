...
function LoginPage() {
  ...
  return (
    <div className="flex min-h-svh overflow-hidden bg-app text-text antialiased">
      <div className="relative flex w-full shrink-0 flex-col border-r border-border px-6 py-11.5 sm:px-14 lg:w-1/2 lg:max-w-180">
      ...
      <div className="relative hidden flex-1 items-center justify-center overflow-hidden bg-inset lg:flex">
        <div className="relative z-10 size-135 max-w-4/5">
          <OrchidAperture />
        </div>
      </div>
    </div>
