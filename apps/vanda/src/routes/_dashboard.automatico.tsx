...
> = {
  ...
  analyzing: { label: "Analisando mecanismo", tone: "creating" },
  directing: { label: "Criando direções", tone: "creating" },
  selecting_direction: { label: "Escolhendo direção", tone: "creating" },
  reviewing_brief: { label: "Revisando brief", tone: "creating" },
  ready_for_production: { label: "Brief pronto", tone: "needs" },
