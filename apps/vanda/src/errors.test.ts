...
import { errorCode, errorCopy, errorMessage, publicError, type ErrorCode } from "./errors";

describe("public errors", () => {
  it.each(Object.keys(errorCopy) as ErrorCode[])(
    "round-trips %s without exposing diagnostic fields",
    (code) => {
