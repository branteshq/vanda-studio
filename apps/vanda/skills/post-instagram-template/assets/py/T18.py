"""T18 Citação de estudo · post só texto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': '“[Trecho curto de um estudo, lei ou referência da sua área.]”',  # 78px, título, 400, escuro
    'texto03': 'Fonte: [autor, instituição, ano]',  # 28px, texto, 700, neutro
    'texto04': '[O que isso significa na prática para o seu cliente, em uma frase.]',  # 36px, texto, 500, escuro
}
...
LAYOUT = [
    ...
    {"op":"box","box":[96,692.64,100,8],"radius":0,"fill":["accent",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto02","content":[96,730.64,888,240.98],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":78,"weight":400,"lineHeight":80.34,"tracking":-1.56,"upper":False,"align":"left","lines":3,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto03","content":[96,1001.63,888,38],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":28,"weight":700,"lineHeight":35,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"box","box":[96,1125.63,888,136.38],"radius":0,"fill":None,"gradient":None,"borders":{"t":[2,"solid",["dark",1]]}},
    {"op":"text","key":"texto04","content":[96,1157.63,888,104.38],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":36,"weight":500,"lineHeight":52.2,"tracking":0,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["dark",1]}},
]
