"""T06 Definição de dicionário · post só texto (1080×1350)."""
...
# Envolva em **asteriscos** o trecho que recebe o estilo de destaque do modelo.
TEXTOS = {
    'texto01': '@[seuperfil]',  # 26px, texto, 600, neutro
    'texto02': '[termo técnico]',  # 120px, título, 700, escuro
    'texto03': '[substantivo] · /[pronúncia]/',  # 30px, texto, 400, neutro
    'texto04': '1.** [Definição simples, como se explicasse para um amigo.]**',  # 42px, texto, 500, destaque, **trecho** = destaque
    'texto05': '2.** [Exemplo de uso no dia a dia do cliente.]**',  # 36px, texto, 400, destaque, **trecho** = destaque
    'texto06': '[Seu nome] · [Profissão]',  # 28px, texto, 700, neutro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[96,449.92,888,123.59],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":120,"weight":700,"lineHeight":123.6,"tracking":-2.4,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto03","content":[96,599.52,888,41],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":30,"weight":400,"lineHeight":37.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1],"italic":True}},
    {"op":"box","box":[96,666.52,888,2],"radius":0,"fill":["dark",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto04","content":[96,694.52,888,122.78],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":42,"weight":500,"lineHeight":60.9,"tracking":0,"upper":False,"align":"left","lines":3,"bg":None,"style":{"color":["accent",1]},"emph":{"color":["dark",1]}},
    {"op":"text","key":"texto05","content":[96,843.3,888,52.19],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":36,"weight":400,"lineHeight":52.2,"tracking":0,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["accent",1]},"emph":{"color":["mix:0.265",1]}},
    {"op":"text","key":"texto06","content":[96,1221.41,888,40.59],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":28,"weight":700,"lineHeight":40.6,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
]
