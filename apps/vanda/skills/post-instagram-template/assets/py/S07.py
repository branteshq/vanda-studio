"""S07 Agenda aberta · post único com foto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': 'Agenda aberta',  # 24px, texto, 800, claro, caixa alta automática, pílula
    'texto03': 'Horários para [mês]',  # 104px, título, 600, claro
    'texto04': '[Serviço 1] · [Serviço 2] · [Serviço 3]',  # 32px, texto, 600, neutro
    'texto05': 'Agende pelo link na bio',  # 32px, texto, 800, claro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[124,887.5,233.03,33],"pads":[14,28,14,28],"hug":True,"anchor":"left","maxW":832,"role":"body","size":24,"weight":800,"lineHeight":30,"tracking":2.88,"upper":True,"align":"left","lines":1,"bg":{"box":[96,873.5,289.03,61],"radius":30.5,"fill":["accent",1],"gradient":None,"borders":None},"style":{"color":["light",1]}},
    {"op":"text","key":"texto03","content":[96,960.5,888,107.11],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":104,"weight":600,"lineHeight":107.12,"tracking":-2.08,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    ...
    {"op":"text","key":"texto05","content":[132,1196,360.33,44],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":816,"role":"body","size":32,"weight":800,"lineHeight":40,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
