"""T10 Opinião impopular · post só texto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': 'Opinião impopular',  # 26px, texto, 800, escuro, caixa alta automática, pílula
    'texto03': '“[Algo que você acredita e a maioria do seu mercado discorda.]”',  # 92px, título, 600, escuro
    'texto04': 'Concorda ou discorda? Comenta aí.',  # 30px, texto, 700, escuro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[129,239,326.67,36],"pads":[19,33,19,33],"hug":True,"anchor":"left","maxW":822,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":{"box":[96,220,392.67,74],"radius":37,"fill":None,"gradient":None,"borders":{"t":[3,"solid",["dark",1]],"r":[3,"solid",["dark",1]],"b":[3,"solid",["dark",1]],"l":[3,"solid",["dark",1]]}},"style":{"color":["dark",1]}},
    {"op":"text","key":"texto03","content":[96,615.38,888,284.25],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":92,"weight":600,"lineHeight":94.76,"tracking":-1.84,"upper":False,"align":"left","lines":3,"bg":None,"style":{"color":["dark",1]}},
    ...
    {"op":"text","key":"texto04","content":[146,1221,514.78,41],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":838,"role":"body","size":30,"weight":700,"lineHeight":37.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
]
