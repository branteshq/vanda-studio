"""T13 Sinais de alerta · post só texto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': 'Atenção',  # 26px, texto, 800, neutro, caixa alta automática
    'texto03': '[N] sinais de que você precisa de [serviço]',  # 84px, título, 600, claro
    'texto04': '[Sinal 1]',  # 36px, texto, 500, claro
    'texto05': '[Sinal 2]',  # 36px, texto, 500, claro
    'texto06': '[Sinal 3]',  # 36px, texto, 500, claro
    'texto07': '[Sinal 4]',  # 36px, texto, 500, claro
    'texto08': 'Se marcou dois ou mais, fale comigo.',  # 28px, texto, 700, neutro
}

LAYOUT = [
    {"op":"box","box":[0,0,1080,1350],"radius":0,"fill":["light",1],"gradient":None,"borders":None},
    {"op":"box","box":[0,0,1080,1350],"radius":0,"fill":["dark",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto01","content":[96,88,154.95,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":26,"weight":600,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.691",1]}},
    {"op":"text","key":"texto02","content":[96,180,147.66,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.613",1]}},
    {"op":"text","key":"texto03","content":[96,252,888,173.03],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":84,"weight":600,"lineHeight":86.52,"tracking":-1.68,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["light",1]}},
    {"op":"box","box":[96,481.03,888,99],"radius":20,"fill":None,"gradient":None,"borders":{"t":[1,"solid",["mix:0.147",1]],"r":[1,"solid",["mix:0.147",1]],"b":[1,"solid",["mix:0.147",1]],"l":[1,"solid",["mix:0.147",1]]}},
    {"op":"icon","strokes":[{"parts":[[[135,520.5],[155,540.5]]],"stroke":["mix:0.363",1],"fill":None,"width":4},{"parts":[[[155,520.5],[135,540.5]]],"stroke":["mix:0.363",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto04","content":[185,506.03,133.06,49],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":770,"role":"body","size":36,"weight":500,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    {"op":"box","box":[96,598.03,888,99],"radius":20,"fill":None,"gradient":None,"borders":{"t":[1,"solid",["mix:0.147",1]],"r":[1,"solid",["mix:0.147",1]],"b":[1,"solid",["mix:0.147",1]],"l":[1,"solid",["mix:0.147",1]]}},
    {"op":"icon","strokes":[{"parts":[[[135,637.5],[155,657.5]]],"stroke":["mix:0.363",1],"fill":None,"width":4},{"parts":[[[155,637.5],[135,657.5]]],"stroke":["mix:0.363",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto05","content":[185,623.03,139.27,49],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":770,"role":"body","size":36,"weight":500,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    {"op":"box","box":[96,715.03,888,99],"radius":20,"fill":None,"gradient":None,"borders":{"t":[1,"solid",["mix:0.147",1]],"r":[1,"solid",["mix:0.147",1]],"b":[1,"solid",["mix:0.147",1]],"l":[1,"solid",["mix:0.147",1]]}},
    {"op":"icon","strokes":[{"parts":[[[135,754.5],[155,774.5]]],"stroke":["mix:0.363",1],"fill":None,"width":4},{"parts":[[[155,754.5],[135,774.5]]],"stroke":["mix:0.363",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto06","content":[185,740.03,138.7,49],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":770,"role":"body","size":36,"weight":500,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    {"op":"box","box":[96,832.03,888,99],"radius":20,"fill":None,"gradient":None,"borders":{"t":[1,"solid",["mix:0.147",1]],"r":[1,"solid",["mix:0.147",1]],"b":[1,"solid",["mix:0.147",1]],"l":[1,"solid",["mix:0.147",1]]}},
    {"op":"icon","strokes":[{"parts":[[[135,871.5],[155,891.5]]],"stroke":["mix:0.363",1],"fill":None,"width":4},{"parts":[[[155,871.5],[135,891.5]]],"stroke":["mix:0.363",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto07","content":[185,857.03,139.91,49],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":770,"role":"body","size":36,"weight":500,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto08","content":[96,1224,888,38],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":28,"weight":700,"lineHeight":35,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.941",1]}},
]
