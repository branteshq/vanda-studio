"""Main Apresentação · post único com foto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': '[Especialidade]',  # 24px, texto, 800, claro, caixa alta automática, pílula
    'texto03': '[Seu nome]',  # 120px, título, 600, claro
    'texto04': '[Registro profissional] · [Cidade]',  # 32px, texto, 400, neutro
    'texto05': 'Muito prazer. Aqui eu falo sobre [tema] sem complicação.',  # 34px, texto, 500, claro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[124,876.42,248.86,33],"pads":[14,28,14,28],"hug":True,"anchor":"left","maxW":832,"role":"body","size":24,"weight":800,"lineHeight":30,"tracking":2.88,"upper":True,"align":"left","lines":1,"bg":{"box":[96,862.42,304.86,61],"radius":30.5,"fill":["accent",1],"gradient":None,"borders":None},"style":{"color":["light",1]}},
    {"op":"text","key":"texto03","content":[96,949.42,888,123.59],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":120,"weight":600,"lineHeight":123.6,"tracking":-2.4,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto04","content":[96,1099.02,888,46.39],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":32,"weight":400,"lineHeight":46.4,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.912",1]}},
    {"op":"text","key":"texto05","content":[96,1171.41,888,98.59],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":34,"weight":500,"lineHeight":49.3,"tracking":0,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["light",1]}},
]
