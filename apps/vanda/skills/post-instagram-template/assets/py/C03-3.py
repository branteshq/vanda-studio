"""C03-3 Mitos e verdades 3/5 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c03-3.png"
...
TEXTOS = {
    ...
    'texto03': 'Mito 2',  # 26px, texto, 800, neutro, caixa alta automática
    'texto04': '“[Crença errada 2.]”',  # 64px, título, 400, claro
    'texto05': 'Verdade',  # 26px, texto, 800, destaque, caixa alta automática
    'texto06': '[O que realmente acontece, explicado em linguagem simples.]',  # 42px, texto, 500, escuro
    'texto07': 'Arraste',  # 28px, texto, 700, escuro
}

LAYOUT = [
    {"op":"box","box":[0,0,1080,1350],"radius":0,"fill":["light",1],"gradient":None,"borders":None},
    {"op":"box","box":[0,0,1080,620],"radius":0,"fill":["dark",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto01","content":[96,80,154.95,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":26,"weight":600,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.691",1]}},
    {"op":"text","key":"texto02","content":[908.16,80,75.84,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.691",1]}},
    {"op":"icon","strokes":[{"parts":[[[106,182],[126,202]]],"stroke":["mix:0.363",1],"fill":None,"width":4},{"parts":[[[126,182],[106,202]]],"stroke":["mix:0.363",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto03","content":[152,174,108.38,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":832,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.613",1]}},
    {"op":"text","key":"texto04","content":[96,238,888,71.67],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":64,"weight":400,"lineHeight":71.68,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    {"op":"icon","strokes":[{"parts":[[[102.7,720.8],[111.1,729.1],[129.3,710.8]]],"stroke":["accent",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto05","content":[152,702,144.72,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":832,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto06","content":[96,766,888,121.78],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":42,"weight":500,"lineHeight":60.9,"tracking":0,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto07","content":[835.72,1232,100.28,38],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":840,"role":"body","size":28,"weight":700,"lineHeight":35,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"icon","strokes":[{"parts":[[[955.5,1251],[976.5,1251]]],"stroke":["dark",1],"fill":None,"width":3},{"parts":[[[967.5,1242],[976.5,1251],[967.5,1260]]],"stroke":["dark",1],"fill":None,"width":3}]},
]
