"""S05 Depoimento · post único (1080×1350)."""
...
TEXTOS = {
    'texto01': 'O que dizem os clientes',  # 26px, texto, 800, destaque, caixa alta automática
    'texto02': '“[Depoimento real do cliente, com permissão. Curto e específico.]”',  # 60px, título, 400, escuro
    'texto03': '[Nome do cliente]',  # 32px, texto, 700, escuro
    'texto04': '[Serviço realizado]',  # 26px, texto, 400, neutro
    'texto05': '@[seuperfil]',  # 26px, texto, 600, neutro
    'texto06': '[Seu nome]',  # 26px, texto, 600, escuro
}

LAYOUT = [
    {"op":"box","box":[0,0,1080,1350],"radius":0,"fill":["light",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto01","content":[96,88,888,36],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"box","box":[96,168,888,1014],"radius":36,"fill":["card",1],"gradient":None,"borders":None},
    {"op":"icon","strokes":[{"parts":[[[188,244.2],[192.7,254],[193.5,254.4],[203.3,255.6],[203.5,256],[195.7,263.5],[197.8,274.2],[188.4,269.1],[187.6,269.1],[178.2,274.2],[180.3,263.5],[172.5,256],[172.7,255.6],[182.5,254.4],[183.3,254],[188,244.2]]],"stroke":None,"fill":["mix:0.588",1],"width":1.67}]},
    {"op":"icon","strokes":[{"parts":[[[236,244.2],[240.7,254],[241.5,254.4],[251.3,255.6],[251.5,256],[243.7,263.5],[245.8,274.2],[236.4,269.1],[235.6,269.1],[226.2,274.2],[228.3,263.5],[220.5,256],[220.7,255.6],[230.5,254.4],[231.3,254],[236,244.2]]],"stroke":None,"fill":["mix:0.588",1],"width":1.67}]},
    {"op":"icon","strokes":[{"parts":[[[284,244.2],[288.7,254],[289.5,254.4],[299.3,255.6],[299.5,256],[291.7,263.5],[293.8,274.2],[284.4,269.1],[283.6,269.1],[274.2,274.2],[276.3,263.5],[268.5,256],[268.7,255.6],[278.5,254.4],[279.3,254],[284,244.2]]],"stroke":None,"fill":["mix:0.588",1],"width":1.67}]},
    {"op":"icon","strokes":[{"parts":[[[332,244.2],[336.7,254],[337.5,254.4],[347.3,255.6],[347.5,256],[339.7,263.5],[341.8,274.2],[332.4,269.1],[331.6,269.1],[322.2,274.2],[324.3,263.5],[316.5,256],[316.7,255.6],[326.5,254.4],[327.3,254],[332,244.2]]],"stroke":None,"fill":["mix:0.588",1],"width":1.67}]},
    {"op":"icon","strokes":[{"parts":[[[380,244.2],[384.7,254],[385.5,254.4],[395.3,255.6],[395.5,256],[387.7,263.5],[389.8,274.2],[380.4,269.1],[379.6,269.1],[370.2,274.2],[372.3,263.5],[364.5,256],[364.7,255.6],[374.5,254.4],[375.3,254],[380,244.2]]],"stroke":None,"fill":["mix:0.588",1],"width":1.67}]},
    {"op":"text","key":"texto02","content":[168,320,744,216],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":744,"role":"title","size":60,"weight":400,"lineHeight":72,"tracking":0,"upper":False,"align":"left","lines":3,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto03","content":[168,1026,744,44],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":744,"role":"body","size":32,"weight":700,"lineHeight":40,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto04","content":[168,1074,744,36],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":744,"role":"body","size":26,"weight":400,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"text","key":"texto05","content":[96,1226,154.95,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":26,"weight":600,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"text","key":"texto06","content":[840.45,1226,143.55,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":600,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
]
