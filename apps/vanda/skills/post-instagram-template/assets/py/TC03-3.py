"""TC03-3 Pare de x comece a 3/5 · carrossel só texto (1080×1350)."""
...
OUTPUT = "/home/user/out/tc03-3.png"
...
TEXTOS = {
    ...
    'texto03': 'Pare de',  # 26px, texto, 800, neutro, caixa alta automática
    'texto04': '[Hábito ruim 2]',  # 80px, título, 600, escuro
    'texto05': 'Comece a',  # 26px, texto, 800, destaque, caixa alta automática
    'texto06': '[Hábito bom 2]',  # 80px, título, 600, claro
    'texto07': 'Arraste',  # 28px, texto, 700, claro
}

LAYOUT = [
    {"op":"box","box":[0,0,1080,1350],"radius":0,"fill":["light",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto01","content":[96,80,154.95,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":26,"weight":600,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"text","key":"texto02","content":[908.16,80,75.84,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"text","key":"texto03","content":[96,454.61,130.61,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.338",1]}},
    {"op":"text","key":"texto04","content":[96,512.61,888,82.39],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":80,"weight":600,"lineHeight":82.4,"tracking":-1.6,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"box","box":[0,675,1080,675],"radius":0,"fill":["dark",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto05","content":[96,755,888,36],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto06","content":[96,813,888,82.39],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":80,"weight":600,"lineHeight":82.4,"tracking":-1.6,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto07","content":[835.72,1232,100.28,38],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":840,"role":"body","size":28,"weight":700,"lineHeight":35,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
