"""S08 Bastidores · post único com foto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': 'Bastidores',  # 24px, texto, 800, claro, caixa alta automática, pílula
    'texto03': 'Um dia de [profissão]',  # 104px, título, 600, claro
    'texto04': '[Uma frase sobre o que acontece por trás do atendimento.]',  # 34px, texto, 400, neutro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[124,965.3,179.44,33],"pads":[14,28,14,28],"hug":True,"anchor":"left","maxW":832,"role":"body","size":24,"weight":800,"lineHeight":30,"tracking":2.88,"upper":True,"align":"left","lines":1,"bg":{"box":[96,951.3,235.44,61],"radius":30.5,"fill":["accent",1],"gradient":None,"borders":None},"style":{"color":["light",1]}},
    {"op":"text","key":"texto03","content":[96,1038.3,888,107.11],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":104,"weight":600,"lineHeight":107.12,"tracking":-2.08,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto04","content":[96,1171.41,888,98.59],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":34,"weight":400,"lineHeight":49.3,"tracking":0,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["mix:0.912",1]}},
]
