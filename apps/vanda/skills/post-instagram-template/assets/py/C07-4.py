"""C07-4 Sobre mim 4/5 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c07-4.png"
...
TEXTOS = {
    ...
    'texto04': 'Como eu trabalho',  # 26px, texto, 800, destaque, caixa alta automática
    'texto05': '[Seu jeito de atender]',  # 82px, título, 600, escuro
    'texto06': '[O que o cliente pode esperar de você.]',  # 36px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto04","content":[292.19,255.75,322.25,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":691.81,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
