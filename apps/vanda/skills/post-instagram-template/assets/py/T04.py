"""T04 Pergunta e resposta · post só texto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': 'P.',  # 120px, título, 700, claro
    'texto03': '[A pergunta que o cliente sempre faz?]',  # 70px, título, 600, claro
    'texto04': 'R.',  # 120px, título, 700, destaque
    'texto05': '[Resposta direta, em linguagem simples. Três ou quatro frases no máximo, sem jargão técnico.]',  # 42px, texto, 500, escuro
    'texto06': 'Salve para lembrar depois',  # 28px, texto, 700, escuro
}

LAYOUT = [
    {"op":"box","box":[0,0,1080,1350],"radius":0,"fill":["light",1],"gradient":None,"borders":None},
    {"op":"box","box":[0,0,1080,560],"radius":0,"fill":["accent",1],"gradient":None,"borders":None},
    ...
    {"op":"text","key":"texto02","content":[96,335.81,106.09,96],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"title","size":120,"weight":700,"lineHeight":96,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",0.5]}},
    {"op":"text","key":"texto03","content":[230.09,335.81,753.91,144.19],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"title","size":70,"weight":600,"lineHeight":72.1,"tracking":-1.4,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto04","content":[96,640,111.42,96],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"title","size":120,"weight":700,"lineHeight":96,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto05","content":[235.42,640,748.58,182.67],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":42,"weight":500,"lineHeight":60.9,"tracking":0,"upper":False,"align":"left","lines":3,"bg":None,"style":{"color":["dark",1]}},
    {"op":"icon","strokes":[{"parts":[[[104.5,1238.3],[121.4,1238.3],[121.5,1263],[121.3,1263.6],[113.1,1258.1],[104.8,1263.6],[104.5,1263.1],[104.5,1238.3]]],"stroke":["dark",1],"fill":None,"width":2.83}]},
    {"op":"text","key":"texto06","content":[144,1232,347.42,38],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":840,"role":"body","size":28,"weight":700,"lineHeight":35,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
]
