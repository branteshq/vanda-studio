"""TC08-4 Mini-aula 4/6 · carrossel só texto (1080×1350)."""
...
OUTPUT = "/home/user/out/tc08-4.png"
...
TEXTOS = {
    ...
    'texto02': '04/06',  # 26px, texto, 700, neutro
    'texto03': 'Parte 3',  # 26px, texto, 800, destaque, caixa alta automática
    'texto04': '[Conceito 3]',  # 80px, título, 600, escuro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[906.53,88,77.47,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"text","key":"texto03","content":[96,220,128.03,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto04","content":[96,292,888,82.39],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":80,"weight":600,"lineHeight":82.4,"tracking":-1.6,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto05","content":[96,410.39,888,110.19],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":38,"weight":400,"lineHeight":55.1,"tracking":0,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["mix:0.265",1]}},
