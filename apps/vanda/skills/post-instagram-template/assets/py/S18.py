"""S18 Nova especialização · post único com foto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': 'Nova conquista',  # 24px, texto, 800, claro, caixa alta automática, pílula
    'texto03': 'Concluí [nome do curso ou especialização]',  # 92px, título, 600, claro
    'texto04': '[Instituição] · [Ano]. [O que isso muda no seu atendimento.]',  # 32px, texto, 400, neutro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[124,935.11,253.45,33],"pads":[14,28,14,28],"hug":True,"anchor":"left","maxW":832,"role":"body","size":24,"weight":800,"lineHeight":30,"tracking":2.88,"upper":True,"align":"left","lines":1,"bg":{"box":[96,921.11,309.45,61],"radius":30.5,"fill":["accent",1],"gradient":None,"borders":None},"style":{"color":["light",1]}},
    {"op":"text","key":"texto03","content":[96,1008.11,888,189.5],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":92,"weight":600,"lineHeight":94.76,"tracking":-1.84,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto04","content":[96,1223.61,888,46.39],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":32,"weight":400,"lineHeight":46.4,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.912",1]}},
]
