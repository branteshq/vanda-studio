"""C02-5 Como funciona 5/5 · carrossel com foto (1080×1350)."""
...
OUTPUT = "/home/user/out/c02-5.png"
...
TEXTOS = {
    ...
    'texto02': '05/05',  # 26px, texto, 700, neutro
    'texto03': 'Vamos começar?',  # 96px, título, 600, claro
    'texto04': 'Agende sua primeira conversa pelo link na bio.',  # 36px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[908.05,88,75.95,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.691",1]}},
    {"op":"photo","key":"foto1","box":[96,190,260,260],"radius":130,"label":["Foto"]},
    {"op":"text","key":"texto03","content":[96,486,888,98.88],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":96,"weight":600,"lineHeight":98.88,"tracking":-1.92,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto04","content":[96,620.88,888,52.19],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":36,"weight":400,"lineHeight":52.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.814",1]}},
