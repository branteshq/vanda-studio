"""TC03-4 Pare de x comece a 4/5 · carrossel só texto (1080×1350)."""
...
OUTPUT = "/home/user/out/tc03-4.png"
...
TEXTOS = {
    ...
    'texto04': '[Hábito ruim 3]',  # 80px, título, 600, escuro
    'texto05': 'Comece a',  # 26px, texto, 800, destaque, caixa alta automática
    'texto06': '[Hábito bom 3]',  # 80px, título, 600, claro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[907.47,80,76.53,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
