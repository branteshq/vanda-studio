"""S02 Citação · post único com foto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': '“',  # 220px, título, 400, destaque
    'texto03': '[Uma frase curta que resume como você trabalha.]',  # 76px, título, 400, claro
    'texto04': '[Seu nome] · [Profissão]',  # 30px, texto, 700, neutro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[96,907.97,888,110],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":220,"weight":400,"lineHeight":132,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto03","content":[96,1043.97,888,156.53],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":76,"weight":400,"lineHeight":78.28,"tracking":-1.52,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto04","content":[96,1226.5,888,43.5],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":30,"weight":700,"lineHeight":43.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.912",1]}},
]
