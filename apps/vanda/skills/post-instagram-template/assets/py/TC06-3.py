"""TC06-3 Faça x não faça 3/5 · carrossel só texto (1080×1350)."""
...
OUTPUT = "/home/user/out/tc06-3.png"
...
TEXTOS = {
    ...
    'texto03': '[Situação 2]',  # 76px, título, 600, escuro
    'texto04': 'Faça',  # 26px, texto, 800, destaque, caixa alta automática
    'texto05': '[O jeito certo]',  # 36px, texto, 400, escuro
    'texto06': 'Não faça',  # 26px, texto, 800, neutro, caixa alta automática
    'texto07': '[O erro comum]',  # 36px, texto, 400, claro
    'texto08': 'Arraste',  # 28px, texto, 700, escuro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto03","content":[96,160,888,78.27],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":76,"weight":600,"lineHeight":78.28,"tracking":-1.52,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"box","box":[96,294.27,888,166.39],"radius":26,"fill":["card",1],"gradient":None,"borders":None},
    {"op":"icon","strokes":[{"parts":[[[142.7,351.1],[151.1,359.3],[169.3,341.1]]],"stroke":["accent",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto04","content":[196,330.27,228.13,36],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":228.13,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto05","content":[196,374.27,228.13,50.39],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":228.13,"role":"body","size":36,"weight":400,"lineHeight":50.4,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"box","box":[96,480.66,888,166.39],"radius":26,"fill":["dark",1],"gradient":None,"borders":None},
    {"op":"icon","strokes":[{"parts":[[[146,526.7],[166,546.7]]],"stroke":["mix:0.363",1],"fill":None,"width":4},{"parts":[[[166,526.7],[146,546.7]]],"stroke":["mix:0.363",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto06","content":[196,516.66,258.05,36],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":258.05,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.613",1]}},
    {"op":"text","key":"texto07","content":[196,560.66,258.05,50.39],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":258.05,"role":"body","size":36,"weight":400,"lineHeight":50.4,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto08","content":[835.72,1224,100.28,38],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":840,"role":"body","size":28,"weight":700,"lineHeight":35,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
