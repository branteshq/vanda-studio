"""C06-2 Estudo de caso 2/5 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c06-2.png"
...
TEXTOS = {
    ...
    'texto04': 'O problema',  # 26px, texto, 800, destaque, caixa alta automática
    'texto05': '[Situação inicial do cliente]',  # 82px, título, 600, escuro
    'texto06': '[O que estava acontecendo e por que preocupava.]',  # 36px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto04","content":[270.06,255.75,201.44,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":713.94,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
