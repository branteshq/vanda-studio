"""C08-3 Serviços 3/5 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c08-3.png"
...
TEXTOS = {
    ...
    'texto04': 'Serviço',  # 26px, texto, 800, destaque, caixa alta automática
    'texto05': '[Nome do serviço 2]',  # 82px, título, 600, escuro
    'texto06': '[Para quem é e o que resolve.]',  # 36px, texto, 400, neutro
    'texto07': 'Inclui',  # 26px, texto, 800, destaque, caixa alta automática
    'texto08': '[O que está incluso].',  # 34px, texto, 500, escuro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto04","content":[298.78,255.75,139.47,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":685.22,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
