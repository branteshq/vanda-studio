"""C01-3 Erros comuns 3/5 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c01-3.png"
...
TEXTOS = {
    ...
    'texto03': '02',  # 150px, título, 700, destaque
    'texto04': 'Erro',  # 26px, texto, 800, destaque, caixa alta automática
    'texto05': '[Nome do erro 2]',  # 82px, título, 600, escuro
    'texto06': '[Por que isso é um problema, em duas frases.]',  # 36px, texto, 400, neutro
    'texto07': 'Faça assim',  # 26px, texto, 800, destaque, caixa alta automática
    'texto08': '[A correção prática, em uma frase.]',  # 34px, texto, 500, escuro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto03","content":[96,210,182.78,127.5],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"title","size":150,"weight":700,"lineHeight":127.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto04","content":[298.78,255.75,84.45,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":685.22,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto05","content":[96,373.5,888,84.45],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":82,"weight":600,"lineHeight":84.46,"tracking":-1.64,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto06","content":[96,493.95,888,52.19],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":36,"weight":400,"lineHeight":52.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"box","box":[96,582.14,888,177.3],"radius":28,"fill":["card",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto07","content":[140,622.14,800,36],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":800,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto08","content":[140,670.14,800,49.3],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":800,"role":"body","size":34,"weight":500,"lineHeight":49.3,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
