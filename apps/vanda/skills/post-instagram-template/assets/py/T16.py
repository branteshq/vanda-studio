"""T16 Enquete A ou B · post só texto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': 'Enquete',  # 26px, texto, 800, destaque, caixa alta automática
    'texto03': '[Pergunta com duas opções?]',  # 88px, título, 600, escuro
    'texto04': 'A',  # 90px, título, 700, claro
    'texto05': '[Opção A]',  # 42px, texto, 700, claro
    'texto06': 'B',  # 90px, título, 700, claro
    'texto07': '[Opção B]',  # 42px, texto, 700, claro
    'texto08': 'Responde nos comentários com A ou B.',  # 30px, texto, 700, neutro
}
...
LAYOUT = [
    ...
    {"op":"box","box":[96,838.5,888,160],"radius":28,"fill":["accent",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto04","content":[140,882.5,59.31,72],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":800,"role":"title","size":90,"weight":700,"lineHeight":72,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto05","content":[227.31,889.5,201.3,58],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":712.69,"role":"body","size":42,"weight":700,"lineHeight":52.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    {"op":"box","box":[96,1022.5,888,160],"radius":28,"fill":["dark",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto06","content":[140,1066.5,61.61,72],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":800,"role":"title","size":90,"weight":700,"lineHeight":72,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto07","content":[229.61,1073.5,199.64,58],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":710.39,"role":"body","size":42,"weight":700,"lineHeight":52.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto08","content":[96,1218.5,888,43.5],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":30,"weight":700,"lineHeight":43.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
]
