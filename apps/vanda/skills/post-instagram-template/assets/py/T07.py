"""T07 Post estilo nota · post só texto (1080×1350)."""
...
TEXTOS = {
    'texto01': '[AB]',  # 44px, título, 700, claro
    'texto02': '[Seu nome]',  # 34px, texto, 800, escuro
    'texto03': '@[seuperfil]',  # 28px, texto, 400, neutro
    'texto04': '[Um pensamento curto, no tom de conversa. Parece um tweet: direto, pessoal e com opinião.]',  # 48px, texto, 500, escuro
    'texto05': '[Profissão] · [Cidade]',  # 26px, texto, 400, neutro
}

LAYOUT = [
    {"op":"box","box":[0,0,1080,1350],"radius":0,"fill":["light",1],"gradient":None,"borders":None},
    {"op":"box","box":[96,410.81,888,528.39],"radius":36,"fill":["card",1],"gradient":None,"borders":{"t":[1,"solid",["mix:0.853",1]],"r":[1,"solid",["mix:0.853",1]],"b":[1,"solid",["mix:0.853",1]],"l":[1,"solid",["mix:0.853",1]]}},
    {"op":"text","key":"texto01","content":[161,475.81,96,96],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":96,"role":"title","size":44,"weight":700,"lineHeight":55,"tracking":0,"upper":False,"align":"left","lines":1,"bg":{"box":[161,475.81,96,96],"radius":48,"fill":["accent",1],"gradient":None,"borders":None},"style":{"color":["light",1]}},
    {"op":"text","key":"texto02","content":[279,479.81,193.81,46],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":193.81,"role":"body","size":34,"weight":800,"lineHeight":42.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto03","content":[279,529.81,193.81,38],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":193.81,"role":"body","size":28,"weight":400,"lineHeight":35,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"text","key":"texto04","content":[161,607.81,758,194.39],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":758,"role":"body","size":48,"weight":500,"lineHeight":64.8,"tracking":0,"upper":False,"align":"left","lines":3,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto05","content":[161,838.2,758,36],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":758,"role":"body","size":26,"weight":400,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
]
