"""C09-1 Lista de dicas 1/6 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c09-1.png"
...
TEXTOS = {
    ...
    'texto02': '01/06',  # 26px, texto, 700, neutro
    'texto03': '[5]',  # 230px, título, 700, destaque
    'texto04': 'Dicas',  # 26px, texto, 800, neutro, caixa alta automática
    'texto05': 'dicas para [resultado que o público quer]',  # 96px, título, 600, claro
    'texto06': 'A terceira quase ninguém sabe.',  # 34px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[910.97,88,73.03,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.941",1]}},
