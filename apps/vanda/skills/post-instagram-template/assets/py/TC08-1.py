"""TC08-1 Mini-aula 1/6 · carrossel só texto (1080×1350)."""
...
OUTPUT = "/home/user/out/tc08-1.png"
...
TEXTOS = {
    ...
    'texto03': '5 min',  # 230px, título, 700, destaque
    'texto04': 'Mini-aula',  # 26px, texto, 800, neutro, caixa alta automática
    'texto05': 'Entenda [assunto complexo] em 5 minutos',  # 100px, título, 600, claro
    'texto06': 'Explicado do zero.',  # 34px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto03","content":[96,472.2,888,195.5],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":230,"weight":700,"lineHeight":195.5,"tracking":-9.2,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto04","content":[96,697.7,888,36],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.941",1]}},
    {"op":"text","key":"texto05","content":[96,763.7,888,309],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":100,"weight":600,"lineHeight":103,"tracking":-2,"upper":False,"align":"left","lines":3,"bg":None,"style":{"color":["light",1]}},
