"""C11-3 Comparativo 3/4 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c11-3.png"
...
TEXTOS = {
    ...
    'texto03': '→',  # 150px, título, 700, destaque
    'texto04': 'Minha recomendação',  # 26px, texto, 800, destaque, caixa alta automática
    'texto05': '[Quando escolher cada uma]',  # 82px, título, 600, escuro
    'texto06': '[Critério simples para decidir.]',  # 36px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[907.58,88,76.42,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"text","key":"texto03","content":[96,210,150,127.5],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"title","size":150,"weight":700,"lineHeight":127.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto04","content":[266,255.75,375.45,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":718,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto05","content":[96,373.5,888,168.91],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":82,"weight":600,"lineHeight":84.46,"tracking":-1.64,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto06","content":[96,578.41,888,52.19],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":36,"weight":400,"lineHeight":52.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
