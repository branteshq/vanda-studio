"""S16 Oferta · post único (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': 'Por tempo limitado',  # 28px, texto, 800, destaque, caixa alta automática, pílula
    'texto03': '[Nome da condição especial]',  # 96px, título, 600, escuro
    'texto04': '[PREÇO]',  # 220px, título, 700, destaque
    'texto05': '[O que está incluso]. Válido até [data].',  # 34px, texto, 400, neutro
    'texto06': 'Garanta pelo link na bio',  # 32px, texto, 800, claro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[133,223,359.53,38],"pads":[23,37,23,37],"hug":True,"anchor":"left","maxW":814,"role":"body","size":28,"weight":800,"lineHeight":35,"tracking":3.36,"upper":True,"align":"left","lines":1,"bg":{"box":[96,200,433.53,84],"radius":42,"fill":None,"gradient":None,"borders":{"t":[3,"solid",["accent",1]],"r":[3,"solid",["accent",1]],"b":[3,"solid",["accent",1]],"l":[3,"solid",["accent",1]]}},"style":{"color":["accent",1]}},
    {"op":"text","key":"texto03","content":[96,320,888,197.75],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":96,"weight":600,"lineHeight":98.88,"tracking":-1.92,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto04","content":[96,553.75,888,198],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":220,"weight":700,"lineHeight":198,"tracking":-8.8,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto05","content":[96,787.75,888,49.3],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":34,"weight":400,"lineHeight":49.3,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"box","box":[96,1158,888,104],"radius":20,"fill":["accent",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto06","content":[132,1188,367.14,44],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":816,"role":"body","size":32,"weight":800,"lineHeight":40,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
