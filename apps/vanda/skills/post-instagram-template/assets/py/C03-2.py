"""C03-2 Mitos e verdades 2/5 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c03-2.png"
...
TEXTOS = {
    ...
    'texto03': 'Mito 1',  # 26px, texto, 800, neutro, caixa alta automática
    'texto04': '“[Crença errada 1.]”',  # 64px, título, 400, claro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[907.8,80,76.2,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.691",1]}},
    ...
    {"op":"text","key":"texto03","content":[152,174,104.47,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":832,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.613",1]}},
