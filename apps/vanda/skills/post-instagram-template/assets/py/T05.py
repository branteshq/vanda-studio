"""T05 Pare x comece · post só texto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': 'Pare de',  # 26px, texto, 800, neutro, caixa alta automática
    'texto03': '[Hábito ruim que o público tem]',  # 84px, título, 600, escuro
    'texto04': 'Comece a',  # 26px, texto, 800, destaque, caixa alta automática
    'texto05': '[Hábito bom que substitui o ruim]',  # 84px, título, 600, claro
    'texto06': '[Por que essa troca faz diferença, em uma frase.]',  # 34px, texto, 400, neutro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[96,363.97,130.61,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.338",1]}},
    {"op":"text","key":"texto03","content":[96,421.97,888,173.03],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":84,"weight":600,"lineHeight":86.52,"tracking":-1.68,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["dark",1]}},
    {"op":"box","box":[0,675,1080,675],"radius":0,"fill":["dark",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto04","content":[96,755,888,36],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto05","content":[96,813,888,173.03],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":84,"weight":600,"lineHeight":86.52,"tracking":-1.68,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto06","content":[96,1008.03,888,49.3],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":34,"weight":400,"lineHeight":49.3,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.814",1]}},
]
