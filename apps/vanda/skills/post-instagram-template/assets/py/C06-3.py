"""C06-3 Estudo de caso 3/5 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c06-3.png"
...
TEXTOS = {
    ...
    'texto04': 'A solução',  # 26px, texto, 800, destaque, caixa alta automática
    'texto05': '[O que foi feito]',  # 82px, título, 600, escuro
    'texto06': '[As etapas principais, em poucas frases.]',  # 36px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto04","content":[298.78,255.75,181.64,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":685.22,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
