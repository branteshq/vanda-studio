"""T14 Faça x não faça · post só texto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': '[Tema]: faça e não faça',  # 80px, título, 600, escuro
    'texto03': 'Faça',  # 26px, texto, 800, destaque, caixa alta automática
    'texto04': '[Faça 1]',  # 32px, texto, 400, escuro
    'texto05': '[Faça 2]',  # 32px, texto, 400, escuro
    'texto06': '[Faça 3]',  # 32px, texto, 400, escuro
    'texto07': '[Faça 4]',  # 32px, texto, 400, escuro
    'texto08': 'Não faça',  # 26px, texto, 800, neutro, caixa alta automática
    'texto09': '[Não faça 1]',  # 32px, texto, 400, claro
    'texto10': '[Não faça 2]',  # 32px, texto, 400, claro
    'texto11': '[Não faça 3]',  # 32px, texto, 400, claro
    'texto12': '[Não faça 4]',  # 32px, texto, 400, claro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[96,160,888,82.39],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":80,"weight":600,"lineHeight":82.4,"tracking":-1.6,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"box","box":[96,298.39,434,963.61],"radius":28,"fill":["card",1],"gradient":None,"borders":None},
    {"op":"icon","strokes":[{"parts":[[[138.7,359.2],[147.1,367.5],[165.3,349.2]]],"stroke":["accent",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto03","content":[184,340.39,81.95,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":310,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto04","content":[132,425.39,362,43.19],"pads":[21,0,0,0],"hug":False,"anchor":"left","maxW":362,"role":"body","size":32,"weight":400,"lineHeight":43.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":{"box":[132,404.39,362,64.19],"radius":0,"fill":None,"gradient":None,"borders":{"t":[1,"solid",["mix:0.853",1]]}},"style":{"color":["dark",1]}},
    {"op":"text","key":"texto05","content":[132,515.58,362,43.19],"pads":[21,0,0,0],"hug":False,"anchor":"left","maxW":362,"role":"body","size":32,"weight":400,"lineHeight":43.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":{"box":[132,494.58,362,64.19],"radius":0,"fill":None,"gradient":None,"borders":{"t":[1,"solid",["mix:0.853",1]]}},"style":{"color":["dark",1]}},
    {"op":"text","key":"texto06","content":[132,605.77,362,43.19],"pads":[21,0,0,0],"hug":False,"anchor":"left","maxW":362,"role":"body","size":32,"weight":400,"lineHeight":43.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":{"box":[132,584.77,362,64.19],"radius":0,"fill":None,"gradient":None,"borders":{"t":[1,"solid",["mix:0.853",1]]}},"style":{"color":["dark",1]}},
    {"op":"text","key":"texto07","content":[132,695.95,362,43.19],"pads":[21,0,0,0],"hug":False,"anchor":"left","maxW":362,"role":"body","size":32,"weight":400,"lineHeight":43.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":{"box":[132,674.95,362,64.19],"radius":0,"fill":None,"gradient":None,"borders":{"t":[1,"solid",["mix:0.853",1]]}},"style":{"color":["dark",1]}},
    {"op":"box","box":[550,298.39,434,963.61],"radius":28,"fill":["dark",1],"gradient":None,"borders":None},
    {"op":"icon","strokes":[{"parts":[[[596,348.4],[616,368.4]]],"stroke":["mix:0.363",1],"fill":None,"width":4},{"parts":[[[616,348.4],[596,368.4]]],"stroke":["mix:0.363",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto08","content":[638,340.39,157.63,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":310,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.613",1]}},
    {"op":"text","key":"texto09","content":[586,425.39,362,43.19],"pads":[21,0,0,0],"hug":False,"anchor":"left","maxW":362,"role":"body","size":32,"weight":400,"lineHeight":43.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":{"box":[586,404.39,362,64.19],"radius":0,"fill":None,"gradient":None,"borders":{"t":[1,"solid",["mix:0.147",1]]}},"style":{"color":["light",1]}},
    {"op":"text","key":"texto10","content":[586,515.58,362,43.19],"pads":[21,0,0,0],"hug":False,"anchor":"left","maxW":362,"role":"body","size":32,"weight":400,"lineHeight":43.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":{"box":[586,494.58,362,64.19],"radius":0,"fill":None,"gradient":None,"borders":{"t":[1,"solid",["mix:0.147",1]]}},"style":{"color":["light",1]}},
    {"op":"text","key":"texto11","content":[586,605.77,362,43.19],"pads":[21,0,0,0],"hug":False,"anchor":"left","maxW":362,"role":"body","size":32,"weight":400,"lineHeight":43.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":{"box":[586,584.77,362,64.19],"radius":0,"fill":None,"gradient":None,"borders":{"t":[1,"solid",["mix:0.147",1]]}},"style":{"color":["light",1]}},
    {"op":"text","key":"texto12","content":[586,695.95,362,43.19],"pads":[21,0,0,0],"hug":False,"anchor":"left","maxW":362,"role":"body","size":32,"weight":400,"lineHeight":43.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":{"box":[586,674.95,362,64.19],"radius":0,"fill":None,"gradient":None,"borders":{"t":[1,"solid",["mix:0.147",1]]}},"style":{"color":["light",1]}},
]
