"""S10 Checklist · post único (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': 'Checklist',  # 26px, texto, 800, destaque, caixa alta automática
    'texto03': '[Antes de (situação), confira:]',  # 84px, título, 600, escuro
    'texto04': '[Item 1]',  # 36px, texto, 500, escuro
    'texto05': '[Item 2]',  # 36px, texto, 500, escuro
    'texto06': '[Item 3]',  # 36px, texto, 500, escuro
    'texto07': '[Item 4]',  # 36px, texto, 500, escuro
    'texto08': '[Item 5]',  # 36px, texto, 500, escuro
    'texto09': 'Salve este checklist',  # 28px, texto, 700, escuro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto03","content":[96,232,888,173.03],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":84,"weight":600,"lineHeight":86.52,"tracking":-1.68,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["dark",1]}},
    {"op":"box","box":[96,441.03,888,101],"radius":20,"fill":["card",1],"gradient":None,"borders":None},
    {"op":"icon","strokes":[{"parts":[[[132.7,492.4],[141.1,500.6],[159.3,482.4]]],"stroke":["accent",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto04","content":[186,467.03,126.34,49],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":768,"role":"body","size":36,"weight":500,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"box","box":[96,564.03,888,101],"radius":20,"fill":["card",1],"gradient":None,"borders":None},
    {"op":"icon","strokes":[{"parts":[[[132.7,615.4],[141.1,623.6],[159.3,605.4]]],"stroke":["accent",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto05","content":[186,590.03,132.56,49],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":768,"role":"body","size":36,"weight":500,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"box","box":[96,687.03,888,101],"radius":20,"fill":["card",1],"gradient":None,"borders":None},
    {"op":"icon","strokes":[{"parts":[[[132.7,738.4],[141.1,746.6],[159.3,728.4]]],"stroke":["accent",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto06","content":[186,713.03,131.98,49],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":768,"role":"body","size":36,"weight":500,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"box","box":[96,810.03,888,101],"radius":20,"fill":["card",1],"gradient":None,"borders":None},
    {"op":"icon","strokes":[{"parts":[[[132.7,861.4],[141.1,869.6],[159.3,851.4]]],"stroke":["accent",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto07","content":[186,836.03,133.19,49],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":768,"role":"body","size":36,"weight":500,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"box","box":[96,933.03,888,101],"radius":20,"fill":["card",1],"gradient":None,"borders":None},
    {"op":"icon","strokes":[{"parts":[[[132.7,984.4],[141.1,992.6],[159.3,974.4]]],"stroke":["accent",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto08","content":[186,959.03,132.63,49],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":768,"role":"body","size":36,"weight":500,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    ...
    {"op":"text","key":"texto09","content":[144,1224,270.27,38],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":840,"role":"body","size":28,"weight":700,"lineHeight":35,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
]
