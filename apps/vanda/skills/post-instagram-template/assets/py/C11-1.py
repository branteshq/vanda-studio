"""C11-1 Comparativo 1/4 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c11-1.png"
...
TEXTOS = {
    ...
    'texto02': '01/04',  # 26px, texto, 700, neutro
    'texto03': 'vs',  # 230px, título, 700, destaque
    'texto04': 'Comparativo',  # 26px, texto, 800, neutro, caixa alta automática
    'texto05': '[Opção A] ou [Opção B]: qual escolher?',  # 96px, título, 600, claro
    'texto06': 'Arraste para comparar.',  # 34px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[911.31,88,72.69,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.941",1]}},
