"""S09 Pergunta da semana · post único (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': '?',  # 130px, título, 700, claro
    'texto03': 'Pergunta da semana',  # 26px, texto, 800, destaque, caixa alta automática
    'texto04': '[Uma pergunta que faz seu público pensar e comentar?]',  # 90px, título, 600, escuro
    'texto05': 'Responde nos comentários',  # 30px, texto, 700, escuro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[96,240,180,180],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":180,"role":"title","size":130,"weight":700,"lineHeight":162.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":{"box":[96,240,180,180],"radius":90,"fill":["accent",1],"gradient":None,"borders":None},"style":{"color":["light",1]}},
    {"op":"text","key":"texto03","content":[96,456,888,36],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto04","content":[96,528,888,278.06],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":90,"weight":600,"lineHeight":92.7,"tracking":-1.8,"upper":False,"align":"left","lines":3,"bg":None,"style":{"color":["dark",1]}},
    {"op":"icon","strokes":[{"parts":[[[102,1231],[125.8,1231],[125.9,1247.5],[110.1,1247.5],[109.2,1247.8],[102.2,1253.3],[102,1231]]],"stroke":["dark",1],"fill":None,"width":3}]},
    {"op":"text","key":"texto05","content":[146,1221,394.66,41],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":838,"role":"body","size":30,"weight":700,"lineHeight":37.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
]
