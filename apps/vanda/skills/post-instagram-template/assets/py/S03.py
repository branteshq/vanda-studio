"""S03 Dica rápida · post único (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': 'Dica rápida',  # 24px, texto, 800, claro, caixa alta automática, pílula
    'texto03': '#[N]',  # 300px, título, 700, destaque
    'texto04': '[Título da dica em até duas linhas]',  # 84px, título, 600, escuro
    'texto05': '[Explique a dica em duas ou três frases simples.]',  # 36px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto01","content":[96,100.5,154.95,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":26,"weight":600,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"text","key":"texto02","content":[773.42,102,182.58,33],"pads":[14,28,14,28],"hug":True,"anchor":"right","maxW":832,"role":"body","size":24,"weight":800,"lineHeight":30,"tracking":2.88,"upper":True,"align":"left","lines":1,"bg":{"box":[745.42,88,238.58,61],"radius":30.5,"fill":["accent",1],"gradient":None,"borders":None},"style":{"color":["light",1]}},
    {"op":"text","key":"texto03","content":[96,185,888,255],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":300,"weight":700,"lineHeight":255,"tracking":-12,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto04","content":[96,476,888,173.03],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":84,"weight":600,"lineHeight":86.52,"tracking":-1.68,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto05","content":[96,685.03,888,52.19],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":36,"weight":400,"lineHeight":52.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    ...
    {"op":"text","key":"texto06","content":[144,1224,347.42,38],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":840,"role":"body","size":28,"weight":700,"lineHeight":35,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
]
