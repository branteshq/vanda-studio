"""C01-2 Erros comuns 2/5 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c01-2.png"
...
TEXTOS = {
    ...
    'texto03': '01',  # 150px, título, 700, destaque
    'texto04': 'Erro',  # 26px, texto, 800, destaque, caixa alta automática
    'texto05': '[Nome do erro 1]',  # 82px, título, 600, escuro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto03","content":[96,210,154.06,127.5],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"title","size":150,"weight":700,"lineHeight":127.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto04","content":[270.06,255.75,84.45,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":713.94,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
