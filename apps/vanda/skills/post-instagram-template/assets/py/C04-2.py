"""C04-2 Perguntas frequentes 2/5 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c04-2.png"
...
TEXTOS = {
    ...
    'texto04': 'Pergunta 1',  # 26px, texto, 800, destaque, caixa alta automática
    'texto05': '[Pergunta frequente 1, do jeito que o cliente pergunta?]',  # 76px, título, 600, escuro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto04","content":[202,226,193.27,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":782,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
