"""C10-1 Antes e depois 1/4 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c10-1.png"
...
TEXTOS = {
    ...
    'texto03': 'Transformação',  # 26px, texto, 800, neutro, caixa alta automática
    'texto04': 'Antes e depois: [nome do caso]',  # 96px, título, 600, claro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto03","content":[96,296,888,36],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.941",1]}},
    {"op":"text","key":"texto04","content":[96,368,888,197.75],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":96,"weight":600,"lineHeight":98.88,"tracking":-1.92,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto05","content":[96,601.75,888,49.3],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":34,"weight":400,"lineHeight":49.3,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.912",1]}},
