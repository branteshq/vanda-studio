"""T12 Glossário · post só texto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': 'Glossário',  # 26px, texto, 800, destaque, caixa alta automática
    'texto03': '[3 termos de (área) explicados]',  # 80px, título, 600, escuro
    'texto04': '[Termo 1]',  # 48px, título, 700, destaque
    'texto05': '[O que significa, em uma frase.]',  # 32px, texto, 400, neutro
    'texto06': '[Termo 2]',  # 48px, título, 700, destaque
    'texto07': '[O que significa, em uma frase.]',  # 32px, texto, 400, neutro
    'texto08': '[Termo 3]',  # 48px, título, 700, destaque
    'texto09': '[O que significa, em uma frase.]',  # 32px, texto, 400, neutro
    'texto10': 'Salve para lembrar depois',  # 28px, texto, 700, escuro
}
...
LAYOUT = [
    ...
    {"op":"box","box":[96,452.78,888,169.8],"radius":0,"fill":None,"gradient":None,"borders":{"t":[2,"solid",["dark",1]]}},
    {"op":"text","key":"texto04","content":[96,482.78,888,59],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":48,"weight":700,"lineHeight":60,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto05","content":[96,549.78,888,44.8],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":32,"weight":400,"lineHeight":44.8,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"box","box":[96,622.58,888,169.8],"radius":0,"fill":None,"gradient":None,"borders":{"t":[2,"solid",["dark",1]]}},
    {"op":"text","key":"texto06","content":[96,652.58,888,59],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":48,"weight":700,"lineHeight":60,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto07","content":[96,719.58,888,44.8],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":32,"weight":400,"lineHeight":44.8,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"box","box":[96,792.38,888,169.8],"radius":0,"fill":None,"gradient":None,"borders":{"t":[2,"solid",["dark",1]]}},
    {"op":"text","key":"texto08","content":[96,822.38,888,59],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":48,"weight":700,"lineHeight":60,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto09","content":[96,889.38,888,44.8],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":32,"weight":400,"lineHeight":44.8,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    ...
    {"op":"text","key":"texto10","content":[144,1224,347.42,38],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":840,"role":"body","size":28,"weight":700,"lineHeight":35,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
]
