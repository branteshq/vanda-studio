"""S17 Galeria · post único com foto (1080×1350)."""
...
TEXTOS = {
    'texto01': '[Tema da galeria]',  # 26px, texto, 800, destaque, caixa alta automática
    'texto02': '[Título curto da galeria]',  # 72px, título, 600, escuro
    'texto03': '@[seuperfil]',  # 26px, texto, 600, neutro
    'texto04': '[Cidade]',  # 26px, texto, 400, neutro
}

LAYOUT = [
    {"op":"box","box":[0,0,1080,1350],"radius":0,"fill":["light",1],"gradient":None,"borders":None},
    {"op":"photo","key":"foto1","box":[64,64,466,440],"radius":24,"label":["Foto 1"]},
    {"op":"photo","key":"foto2","box":[550,64,466,440],"radius":24,"label":["Foto 2"]},
    {"op":"photo","key":"foto3","box":[64,524,466,440],"radius":24,"label":["Foto 3"]},
    {"op":"photo","key":"foto4","box":[550,524,466,440],"radius":24,"label":["Foto 4"]},
    {"op":"text","key":"texto01","content":[64,988,952,36],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":952,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto02","content":[64,1048,952,74.16],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":952,"role":"title","size":72,"weight":600,"lineHeight":74.16,"tracking":-1.44,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto03","content":[64,1146.16,154.95,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":952,"role":"body","size":26,"weight":600,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"text","key":"texto04","content":[911.78,1146.16,104.22,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":952,"role":"body","size":26,"weight":400,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
]
