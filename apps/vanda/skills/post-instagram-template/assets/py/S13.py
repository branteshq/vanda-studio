"""S13 Data comemorativa · post único com foto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': '[Dia] de [mês]',  # 26px, texto, 800, neutro, caixa alta automática
    'texto03': 'Feliz Dia do [profissão ou data]',  # 110px, título, 600, claro
    'texto04': '[Mensagem curta e sincera para quem faz parte dessa história.]',  # 34px, texto, 400, neutro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[96,856.81,888,36],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.941",1]}},
    {"op":"text","key":"texto03","content":[96,918.81,888,226.59],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":110,"weight":600,"lineHeight":113.3,"tracking":-2.2,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["light",1]}},
