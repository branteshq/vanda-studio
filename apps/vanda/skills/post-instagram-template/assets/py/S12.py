"""S12 Novidade · post único com foto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': 'Novidade',  # 24px, texto, 800, claro, caixa alta automática, pílula
    'texto03': 'Agora eu também atendo [novo serviço]',  # 96px, título, 600, claro
    'texto04': '[Para quem é e qual problema resolve, em uma frase.]',  # 34px, texto, 400, neutro
    'texto05': 'Saiba mais no link da bio',  # 32px, texto, 800, claro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[124,793.95,144.94,33],"pads":[14,28,14,28],"hug":True,"anchor":"left","maxW":832,"role":"body","size":24,"weight":800,"lineHeight":30,"tracking":2.88,"upper":True,"align":"left","lines":1,"bg":{"box":[96,779.95,200.94,61],"radius":30.5,"fill":["accent",1],"gradient":None,"borders":None},"style":{"color":["light",1]}},
    {"op":"text","key":"texto03","content":[96,866.95,888,197.75],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":96,"weight":600,"lineHeight":98.88,"tracking":-1.92,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto04","content":[96,1090.7,888,49.3],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":34,"weight":400,"lineHeight":49.3,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.912",1]}},
    {"op":"box","box":[96,1166,888,104],"radius":20,"fill":["accent",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto05","content":[132,1196,380.39,44],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":816,"role":"body","size":32,"weight":800,"lineHeight":40,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
