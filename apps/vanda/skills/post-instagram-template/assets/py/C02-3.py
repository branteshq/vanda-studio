"""C02-3 Como funciona 3/5 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c02-3.png"
...
TEXTOS = {
    ...
    'texto03': '2',  # 84px, título, 700, claro
    'texto04': '[Etapa 2: nome curto]',  # 86px, título, 600, escuro
    'texto05': '[O que acontece nesta etapa e o que o cliente precisa fazer.]',  # 38px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"box","box":[96,160,12,12],"radius":6,"fill":["mix:0.853",1],"gradient":None,"borders":None},
    {"op":"box","box":[118,160,56,12],"radius":6,"fill":["accent",1],"gradient":None,"borders":None},
    {"op":"box","box":[184,160,12,12],"radius":6,"fill":["mix:0.853",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto03","content":[96,248,150,150],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":150,"role":"title","size":84,"weight":700,"lineHeight":105,"tracking":0,"upper":False,"align":"left","lines":1,"bg":{"box":[96,248,150,150],"radius":75,"fill":["accent",1],"gradient":None,"borders":None},"style":{"color":["light",1]}},
    {"op":"text","key":"texto04","content":[96,434,888,88.58],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":86,"weight":600,"lineHeight":88.58,"tracking":-1.72,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto05","content":[96,558.58,888,110.19],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":38,"weight":400,"lineHeight":55.1,"tracking":0,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["mix:0.265",1]}},
