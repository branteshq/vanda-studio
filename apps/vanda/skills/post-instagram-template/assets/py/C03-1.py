"""C03-1 Mitos e verdades 1/5 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c03-1.png"
...
TEXTOS = {
    ...
    'texto03': '[3]',  # 230px, título, 700, claro
    'texto04': 'Mitos e verdades',  # 26px, texto, 800, neutro, caixa alta automática
    'texto05': 'mitos sobre [tema] que você precisa parar de acreditar',  # 96px, título, 600, claro
    'texto06': 'Arraste e confira.',  # 34px, texto, 400, neutro
    'texto07': 'Arraste',  # 28px, texto, 700, claro
}

LAYOUT = [
    {"op":"box","box":[0,0,1080,1350],"radius":0,"fill":["light",1],"gradient":None,"borders":None},
    {"op":"box","box":[0,0,1080,1350],"radius":0,"fill":["accent",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto01","content":[96,88,154.95,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":26,"weight":600,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.941",1]}},
    {"op":"text","key":"texto02","content":[911.89,88,72.11,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.941",1]}},
    {"op":"text","key":"texto03","content":[96,260,888,195.5],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":230,"weight":700,"lineHeight":195.5,"tracking":-9.2,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto04","content":[96,491.5,888,36],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.941",1]}},
    {"op":"text","key":"texto05","content":[96,563.5,888,296.63],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":96,"weight":600,"lineHeight":98.88,"tracking":-1.92,"upper":False,"align":"left","lines":3,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto06","content":[96,896.13,888,49.3],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":34,"weight":400,"lineHeight":49.3,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.912",1]}},
    {"op":"text","key":"texto07","content":[835.72,1224,100.28,38],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":840,"role":"body","size":28,"weight":700,"lineHeight":35,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    {"op":"icon","strokes":[{"parts":[[[955.5,1243],[976.5,1243]]],"stroke":["light",1],"fill":None,"width":3},{"parts":[[[967.5,1234],[976.5,1243],[967.5,1252]]],"stroke":["light",1],"fill":None,"width":3}]},
]
