"""C10-4 Antes e depois 4/4 · carrossel com foto (1080×1350)."""
...
OUTPUT = "/home/user/out/c10-4.png"
...
TEXTOS = {
    ...
    'texto02': '04/04',  # 26px, texto, 700, neutro
    'texto03': 'Quer um resultado assim?',  # 96px, título, 600, claro
    'texto04': 'Agende sua avaliação pelo link na bio.',  # 36px, texto, 400, neutro
    'texto05': 'Salve este post',  # 30px, texto, 800, claro
    'texto06': 'Envie para alguém',  # 30px, texto, 800, claro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[906.88,88,77.13,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.691",1]}},
    {"op":"photo","key":"foto1","box":[96,190,260,260],"radius":130,"label":["Foto"]},
    {"op":"text","key":"texto03","content":[96,486,888,197.75],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":96,"weight":600,"lineHeight":98.88,"tracking":-1.92,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto04","content":[96,719.75,888,52.19],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":36,"weight":400,"lineHeight":52.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.814",1]}},
    {"op":"text","key":"texto05","content":[126,1187,350.58,45],"pads":[30,30,30,30],"hug":False,"anchor":"left","maxW":350.58,"role":"body","size":30,"weight":800,"lineHeight":37.5,"tracking":0,"upper":False,"align":"center","lines":1,"bg":{"box":[96,1157,410.58,105],"radius":20,"fill":["accent",1],"gradient":None,"borders":None},"style":{"color":["light",1]}},
    {"op":"text","key":"texto06","content":[558.58,1189,393.42,41],"pads":[32,32,32,32],"hug":False,"anchor":"left","maxW":393.42,"role":"body","size":30,"weight":800,"lineHeight":37.5,"tracking":0,"upper":False,"align":"center","lines":1,"bg":{"box":[526.58,1157,457.42,105],"radius":20,"fill":None,"gradient":None,"borders":{"t":[2,"solid",["mix:0.941",1]],"r":[2,"solid",["mix:0.941",1]],"b":[2,"solid",["mix:0.941",1]],"l":[2,"solid",["mix:0.941",1]]}},"style":{"color":["light",1]}},
]
