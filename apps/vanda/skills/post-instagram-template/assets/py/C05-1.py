"""C05-1 Guia rápido 1/5 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c05-1.png"
...
TEXTOS = {
    ...
    'texto03': '[4]',  # 230px, título, 700, destaque
    'texto04': 'Guia rápido',  # 26px, texto, 800, neutro, caixa alta automática
    'texto05': 'coisas para saber antes de [decisão do cliente]',  # 96px, título, 600, claro
    'texto06': 'Salve para consultar depois.',  # 34px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto03","content":[96,260,888,195.5],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":230,"weight":700,"lineHeight":195.5,"tracking":-9.2,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    ...
    {"op":"text","key":"texto05","content":[96,563.5,888,197.75],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":96,"weight":600,"lineHeight":98.88,"tracking":-1.92,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto06","content":[96,797.25,888,49.3],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":34,"weight":400,"lineHeight":49.3,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.912",1]}},
