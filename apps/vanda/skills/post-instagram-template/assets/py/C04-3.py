"""C04-3 Perguntas frequentes 3/5 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c04-3.png"
...
TEXTOS = {
    ...
    'texto03': 'P',  # 48px, título, 700, claro
    'texto04': 'Pergunta 2',  # 26px, texto, 800, destaque, caixa alta automática
    'texto05': '[Pergunta frequente 2, do jeito que o cliente pergunta?]',  # 76px, título, 600, escuro
    'texto06': 'Resposta',  # 26px, texto, 800, destaque, caixa alta automática
    'texto07': '[Resposta direta em duas ou três frases, sem jargão.]',  # 36px, texto, 400, escuro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto03","content":[96,200,88,88],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":88,"role":"title","size":48,"weight":700,"lineHeight":60,"tracking":0,"upper":False,"align":"left","lines":1,"bg":{"box":[96,200,88,88],"radius":44,"fill":["accent",1],"gradient":None,"borders":None},"style":{"color":["light",1]}},
    {"op":"text","key":"texto04","content":[202,226,197.17,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":782,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto05","content":[96,324,888,234.8],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":76,"weight":600,"lineHeight":78.28,"tracking":-1.52,"upper":False,"align":"left","lines":3,"bg":None,"style":{"color":["dark",1]}},
    {"op":"box","box":[96,594.8,888,246],"radius":28,"fill":["card",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto06","content":[140,638.8,800,36],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":800,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto07","content":[140,688.8,800,108],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":800,"role":"body","size":36,"weight":400,"lineHeight":54,"tracking":0,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["dark",1]}},
