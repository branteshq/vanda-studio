"""TC01-3 Texto corrido (thread) 3/6 · carrossel só texto (1080×1350)."""
...
OUTPUT = "/home/user/out/tc01-3.png"
...
TEXTOS = {
    ...
    'texto03': '[Parágrafo 2 do seu texto. Frases curtas, uma ideia por slide, como se estivesse contando para alguém.]',  # 60px, título, 400, escuro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto03","content":[96,398.67,888,312],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":60,"weight":400,"lineHeight":78,"tracking":0,"upper":False,"align":"left","lines":4,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto04","content":[835.72,1224,100.28,38],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":840,"role":"body","size":28,"weight":700,"lineHeight":35,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
