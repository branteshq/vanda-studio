"""C05-5 Guia rápido 5/5 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c05-5.png"
...
TEXTOS = {
    ...
    'texto03': '04',  # 150px, título, 700, destaque
    'texto04': 'Ponto',  # 26px, texto, 800, destaque, caixa alta automática
    'texto05': '[Ponto 4]',  # 82px, título, 600, escuro
    'texto06': '[Explicação curta e prática.]',  # 36px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[908.05,88,75.95,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"text","key":"texto03","content":[96,210,184.58,127.5],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"title","size":150,"weight":700,"lineHeight":127.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto04","content":[300.58,255.75,109.34,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":683.42,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
