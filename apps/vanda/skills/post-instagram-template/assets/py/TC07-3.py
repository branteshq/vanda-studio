"""TC07-3 Linha do tempo 3/5 · carrossel só texto (1080×1350)."""
...
OUTPUT = "/home/user/out/tc07-3.png"
...
TEXTOS = {
    ...
    'texto03': '[2010]',  # 130px, título, 700, destaque
    'texto04': '[Marco 2 da sua trajetória]',  # 76px, título, 600, escuro
    'texto05': '[O que aconteceu e o que você aprendeu com isso.]',  # 36px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"box","box":[96,396,36,36],"radius":18,"fill":["accent",1],"gradient":None,"borders":None},
    {"op":"box","box":[112,432,4,520],"radius":0,"fill":["mix:0.853",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto03","content":[172,396,812,110.5],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":812,"role":"title","size":130,"weight":700,"lineHeight":110.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto04","content":[172,530.5,812,156.53],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":812,"role":"title","size":76,"weight":600,"lineHeight":78.28,"tracking":-1.52,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto05","content":[172,711.03,812,104.38],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":812,"role":"body","size":36,"weight":400,"lineHeight":52.2,"tracking":0,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["mix:0.265",1]}},
