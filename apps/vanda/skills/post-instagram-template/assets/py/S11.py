"""S11 Antes e depois · post único com foto (1080×1350)."""
...
FOTOS = {
    'foto1': None,  # Antes · Foto do trabalho
    'foto2': None,  # Depois · Foto do trabalho
}

# Textos de cima para baixo. Troque todo [colchete]; string vazia remove o elemento.
TEXTOS = {
    'texto01': '@[seuperfil]',  # 26px, texto, 600, neutro
    'texto02': '[Nome do caso ou procedimento]',  # 72px, título, 600, escuro
    'texto03': 'Antes',  # 26px, texto, 800, neutro, caixa alta automática
    'texto04': 'Depois',  # 26px, texto, 800, destaque, caixa alta automática
    'texto05': '[Em quanto tempo e o que foi feito. Use só com autorização do cliente.]',  # 28px, texto, 400, neutro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[96,156,888,148.31],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":72,"weight":600,"lineHeight":74.16,"tracking":-1.44,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["dark",1]}},
    {"op":"photo","key":"foto1","box":[96,336.31,434,710],"radius":24,"label":["Antes","Foto do trabalho"]},
    {"op":"text","key":"texto03","content":[96,1060.31,434,36],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":434,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"photo","key":"foto2","box":[550,336.31,434,710],"radius":24,"label":["Depois","Foto do trabalho"]},
    {"op":"text","key":"texto04","content":[550,1060.31,434,36],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":434,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto05","content":[96,1128.31,888,81.19],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":28,"weight":400,"lineHeight":40.6,"tracking":0,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["mix:0.265",1]}},
]
