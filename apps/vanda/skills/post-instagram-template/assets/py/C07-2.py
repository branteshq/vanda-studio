"""C07-2 Sobre mim 2/5 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c07-2.png"
...
TEXTOS = {
    ...
    'texto04': 'Trajetória',  # 26px, texto, 800, destaque, caixa alta automática
    'texto05': '[Como você começou]',  # 82px, título, 600, escuro
    'texto06': '[Dois ou três marcos da sua carreira.]',  # 36px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto04","content":[270.06,255.75,194.56,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":713.94,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
