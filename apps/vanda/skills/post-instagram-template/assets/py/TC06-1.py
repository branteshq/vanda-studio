"""TC06-1 Faça x não faça 1/5 · carrossel só texto (1080×1350)."""
...
OUTPUT = "/home/user/out/tc06-1.png"
...
TEXTOS = {
    ...
    'texto03': 'Guia prático',  # 26px, texto, 800, destaque, caixa alta automática
    'texto04': '[Tema]: o que fazer e o que evitar',  # 100px, título, 600, escuro
    'texto05': 'Situações reais do dia a dia.',  # 34px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[911.89,88,72.11,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"text","key":"texto03","content":[96,800.7,888,36],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto04","content":[96,866.7,888,206],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":100,"weight":600,"lineHeight":103,"tracking":-2,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto05","content":[96,1102.7,888,49.3],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":34,"weight":400,"lineHeight":49.3,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
