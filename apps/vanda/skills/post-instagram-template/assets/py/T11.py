"""T11 Lembrete do dia · post só texto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': 'Lembrete do dia',  # 26px, texto, 800, destaque, caixa alta automática
    'texto03': '[Um lembrete curto e gentil para o seu público.]',  # 84px, título, 600, escuro
    'texto04': '[Seu nome] · [Profissão]',  # 28px, texto, 700, neutro
}
...
LAYOUT = [
    ...
    {"op":"box","box":[96,437.94,888,469.55],"radius":36,"fill":["light",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto02","content":[160,509.94,760,36],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":760,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto03","content":[160,575.94,760,259.55],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":760,"role":"title","size":84,"weight":600,"lineHeight":86.52,"tracking":-1.68,"upper":False,"align":"left","lines":3,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto04","content":[96,1221.41,888,40.59],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":28,"weight":700,"lineHeight":40.6,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.941",1]}},
]
