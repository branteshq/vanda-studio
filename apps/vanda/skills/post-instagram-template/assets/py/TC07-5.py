"""TC07-5 Linha do tempo 5/5 · carrossel só texto (1080×1350)."""
...
OUTPUT = "/home/user/out/tc07-5.png"
...
TEXTOS = {
    ...
    'texto03': 'E essa história continua.',  # 104px, título, 600, claro
    'texto04': 'Obrigado por fazer parte dela.',  # 38px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"box","box":[96,280,120,8],"radius":0,"fill":["accent",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto03","content":[96,324,888,214.22],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":104,"weight":600,"lineHeight":107.12,"tracking":-2.08,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto04","content":[96,574.22,888,55.09],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":38,"weight":400,"lineHeight":55.1,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.814",1]}},
