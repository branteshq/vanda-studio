"""C10-3 Antes e depois 3/4 · carrossel com foto (1080×1350)."""
...
OUTPUT = "/home/user/out/c10-3.png"
...
FOTOS = {
    'foto1': None,  # Depois · Foto do trabalho, não do profissional
}

# Textos de cima para baixo. Troque todo [colchete]; string vazia remove o elemento.
TEXTOS = {
    'texto01': 'Depois',  # 26px, texto, 800, destaque, caixa alta automática
    'texto02': '03/04',  # 26px, texto, 700, neutro
    'texto03': '[O que foi feito e em quanto tempo.]',  # 36px, texto, 500, escuro
    'texto04': 'Arraste',  # 28px, texto, 700, escuro
}

LAYOUT = [
    {"op":"box","box":[0,0,1080,1350],"radius":0,"fill":["light",1],"gradient":None,"borders":None},
    {"op":"photo","key":"foto1","box":[0,0,1080,860],"radius":0,"label":["Depois","Foto do trabalho, não do profissional"]},
    {"op":"text","key":"texto01","content":[96,916,117.39,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto02","content":[907.58,916,76.42,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"text","key":"texto03","content":[96,970,888,52.19],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":36,"weight":500,"lineHeight":52.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto04","content":[835.72,1240,100.28,38],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":840,"role":"body","size":28,"weight":700,"lineHeight":35,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"icon","strokes":[{"parts":[[[955.5,1259],[976.5,1259]]],"stroke":["dark",1],"fill":None,"width":3},{"parts":[[[967.5,1250],[976.5,1259],[967.5,1268]]],"stroke":["dark",1],"fill":None,"width":3}]},
]
