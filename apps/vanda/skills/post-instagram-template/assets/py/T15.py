"""T15 Comunicado · post só texto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': 'Comunicado',  # 24px, texto, 800, claro, caixa alta automática, pílula
    'texto03': '[Título do aviso: feriado, mudança de horário, férias]',  # 80px, título, 600, escuro
    'texto04': '[Detalhes: datas, o que muda e como falar com você nesse período.]',  # 36px, texto, 400, neutro
    'texto05': '[Data de início] a [data de fim]',  # 32px, texto, 700, escuro
}
...
LAYOUT = [
    ...
    {"op":"box","box":[96,369.73,888,682.55],"radius":28,"fill":None,"gradient":None,"borders":{"t":[4,"solid",["dark",1]],"r":[4,"solid",["dark",1]],"b":[4,"solid",["dark",1]],"l":[4,"solid",["dark",1]]}},
    {"op":"text","key":"texto02","content":[192,451.73,196.61,33],"pads":[14,28,14,28],"hug":True,"anchor":"left","maxW":696,"role":"body","size":24,"weight":800,"lineHeight":30,"tracking":2.88,"upper":True,"align":"left","lines":1,"bg":{"box":[164,437.73,252.61,61],"radius":30.5,"fill":["accent",1],"gradient":None,"borders":None},"style":{"color":["light",1]}},
    {"op":"text","key":"texto03","content":[164,528.73,752,247.17],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":752,"role":"title","size":80,"weight":600,"lineHeight":82.4,"tracking":-1.6,"upper":False,"align":"left","lines":3,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto04","content":[164,805.91,752,104.38],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":752,"role":"body","size":36,"weight":400,"lineHeight":52.2,"tracking":0,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"icon","strokes":[{"parts":[[[171.5,951.8],[192.5,951.8],[193.5,952],[194.5,952.6],[195.2,953.5],[195.4,973.6],[194.9,974.6],[194.1,975.4],[193,975.7],[171,975.7],[170,975.4],[169.1,974.6],[168.6,973.6],[168.5,954.5],[168.8,953.5],[169.5,952.6],[170.5,952],[171.5,951.8]]],"stroke":["dark",1],"fill":None,"width":3},{"parts":[[[168.5,959.3],[195.5,959.3]]],"stroke":["dark",1],"fill":None,"width":3},{"parts":[[[176,948.8],[176,954.8]]],"stroke":["dark",1],"fill":None,"width":3},{"parts":[[[188,948.8],[188,954.8]]],"stroke":["dark",1],"fill":None,"width":3}]},
    {"op":"text","key":"texto05","content":[216,940.28,464.44,44],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":700,"role":"body","size":32,"weight":700,"lineHeight":40,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
]
