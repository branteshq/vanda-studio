"""TC08-2 Mini-aula 2/6 · carrossel só texto (1080×1350)."""
...
OUTPUT = "/home/user/out/tc08-2.png"
...
TEXTOS = {
    ...
    'texto02': '02/06',  # 26px, texto, 700, neutro
    'texto03': 'Parte 1',  # 26px, texto, 800, destaque, caixa alta automática
    'texto04': '[Conceito 1]',  # 80px, título, 600, escuro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[906.88,88,77.13,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"text","key":"texto03","content":[96,220,124.47,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
