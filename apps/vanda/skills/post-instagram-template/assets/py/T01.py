"""T01 Manchete · post só texto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': '[UMA AFIRMAÇÃO CURTA E FORTE SOBRE O SEU TEMA.]',  # 124px, título, 700, claro
    'texto03': '[Seu nome] · [Profissão]',  # 28px, texto, 700, neutro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[96,353.41,888,638.59],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":124,"weight":700,"lineHeight":127.72,"tracking":-2.48,"upper":False,"align":"left","lines":5,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto03","content":[96,1221.41,888,40.59],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":28,"weight":700,"lineHeight":40.6,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.941",1]}},
]
