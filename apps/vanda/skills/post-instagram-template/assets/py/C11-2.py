"""C11-2 Comparativo 2/4 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c11-2.png"
...
TEXTOS = {
    ...
    'texto02': '02/04',  # 26px, texto, 700, neutro
    'texto03': '[Opção A] ou [Opção B]?',  # 80px, título, 600, escuro
    'texto04': '[Opção A]',  # 52px, título, 600, escuro
    'texto05': '[Ponto 1]',  # 32px, texto, 400, escuro
    'texto06': '[Ponto 2]',  # 32px, texto, 400, escuro
    'texto07': '[Ponto 3]',  # 32px, texto, 400, escuro
    'texto08': '[Ponto 4]',  # 32px, texto, 400, escuro
    'texto09': '[Opção B]',  # 52px, título, 600, escuro
    'texto10': '[Ponto 1]',  # 32px, texto, 400, escuro
    'texto11': '[Ponto 2]',  # 32px, texto, 400, escuro
    'texto12': '[Ponto 3]',  # 32px, texto, 400, escuro
    'texto13': '[Ponto 4]',  # 32px, texto, 400, escuro
    'texto14': 'Arraste',  # 28px, texto, 700, escuro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[907.22,88,76.78,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"text","key":"texto03","content":[96,160,888,82.39],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":80,"weight":600,"lineHeight":82.4,"tracking":-1.6,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"box","box":[96,298.39,432,424.75],"radius":28,"fill":["card",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto04","content":[136,342.39,352,64],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":352,"role":"title","size":52,"weight":600,"lineHeight":65,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"icon","strokes":[{"parts":[[[146,444.4],[166,464.4]]],"stroke":["mix:0.363",1],"fill":None,"width":4},{"parts":[[[166,444.4],[146,464.4]]],"stroke":["mix:0.363",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto05","content":[192,434.39,133.2,43.19],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":296,"role":"body","size":32,"weight":400,"lineHeight":43.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"icon","strokes":[{"parts":[[[146,511.6],[166,531.6]]],"stroke":["mix:0.363",1],"fill":None,"width":4},{"parts":[[[166,511.6],[146,531.6]]],"stroke":["mix:0.363",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto06","content":[192,501.58,138.95,43.19],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":296,"role":"body","size":32,"weight":400,"lineHeight":43.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"icon","strokes":[{"parts":[[[146,578.8],[166,598.8]]],"stroke":["mix:0.363",1],"fill":None,"width":4},{"parts":[[[166,578.8],[146,598.8]]],"stroke":["mix:0.363",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto07","content":[192,568.77,138.41,43.19],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":296,"role":"body","size":32,"weight":400,"lineHeight":43.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"icon","strokes":[{"parts":[[[146,646],[166,666]]],"stroke":["mix:0.363",1],"fill":None,"width":4},{"parts":[[[166,646],[146,666]]],"stroke":["mix:0.363",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto08","content":[192,635.95,139.58,43.19],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":296,"role":"body","size":32,"weight":400,"lineHeight":43.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"box","box":[552,298.39,432,424.75],"radius":28,"fill":["card",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto09","content":[592,342.39,352,64],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":352,"role":"title","size":52,"weight":600,"lineHeight":65,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"icon","strokes":[{"parts":[[[598.7,455.2],[607.1,463.5],[625.3,445.2]]],"stroke":["accent",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto10","content":[648,434.39,133.2,43.19],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":296,"role":"body","size":32,"weight":400,"lineHeight":43.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"icon","strokes":[{"parts":[[[598.7,522.4],[607.1,530.7],[625.3,512.4]]],"stroke":["accent",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto11","content":[648,501.58,138.95,43.19],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":296,"role":"body","size":32,"weight":400,"lineHeight":43.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"icon","strokes":[{"parts":[[[598.7,589.6],[607.1,597.8],[625.3,579.6]]],"stroke":["accent",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto12","content":[648,568.77,138.41,43.19],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":296,"role":"body","size":32,"weight":400,"lineHeight":43.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"icon","strokes":[{"parts":[[[598.7,656.8],[607.1,665],[625.3,646.8]]],"stroke":["accent",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto13","content":[648,635.95,139.58,43.19],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":296,"role":"body","size":32,"weight":400,"lineHeight":43.2,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto14","content":[835.72,1224,100.28,38],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":840,"role":"body","size":28,"weight":700,"lineHeight":35,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
