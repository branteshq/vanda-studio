"""T17 Carta ao cliente · post só texto (1080×1350)."""
...
TEXTOS = {
    'texto01': 'Querido(a) [cliente],',  # 44px, título, 400, destaque
    'texto02': '[Um conselho ou mensagem que você daria a quem está começando a cuidar de (tema). Tom pessoal, como uma carta.]',  # 44px, título, 400, escuro
    'texto03': 'Com carinho, [seu nome]',  # 40px, título, 400, escuro
    'texto04': '@[seuperfil]',  # 26px, texto, 600, neutro
}

LAYOUT = [
    {"op":"box","box":[0,0,1080,1350],"radius":0,"fill":["light",1],"gradient":None,"borders":None},
    {"op":"box","box":[96,346.91,888,584.19],"radius":12,"fill":["card",1],"gradient":None,"borders":{"t":[1,"solid",["mix:0.853",1]],"r":[1,"solid",["mix:0.853",1]],"b":[1,"solid",["mix:0.853",1]],"l":[1,"solid",["mix:0.853",1]]}},
    {"op":"text","key":"texto01","content":[169,427.91,742,54],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":742,"role":"title","size":44,"weight":400,"lineHeight":55,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1],"italic":True}},
    {"op":"text","key":"texto02","content":[169,513.91,742,255.19],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":742,"role":"title","size":44,"weight":400,"lineHeight":63.8,"tracking":0,"upper":False,"align":"left","lines":4,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto03","content":[169,801.09,742,49],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":742,"role":"title","size":40,"weight":400,"lineHeight":50,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1],"italic":True}},
    {"op":"text","key":"texto04","content":[96,1226,154.95,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":26,"weight":600,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
]
