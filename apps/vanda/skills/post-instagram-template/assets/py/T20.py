"""T20 Pergunta retórica · post só texto (1080×1350)."""
...
TEXTOS = {
    'texto01': '[Você sabia que (fato surpreendente)?]',  # 110px, título, 700, escuro
    'texto02': 'A resposta está na legenda',  # 34px, texto, 700, destaque
    'texto03': '@[seuperfil]',  # 26px, texto, 600, neutro
}

LAYOUT = [
    {"op":"box","box":[0,0,1080,1350],"radius":0,"fill":["light",1],"gradient":None,"borders":None},
    {"op":"box","box":[0,0,1080,1350],"radius":0,"fill":["mix:0.951",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto01","content":[96,482.7,888,226.59],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":110,"weight":700,"lineHeight":113.3,"tracking":-2.2,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto02","content":[96,749.3,442.84,46],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":34,"weight":700,"lineHeight":42.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"icon","strokes":[{"parts":[[[562.3,772.3],[583.3,772.3]]],"stroke":["accent",1],"fill":None,"width":3},{"parts":[[[574.3,763.3],[583.3,772.3],[574.3,781.3]]],"stroke":["accent",1],"fill":None,"width":3}]},
    {"op":"text","key":"texto03","content":[96,1226,154.95,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":26,"weight":600,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
]
