"""C12-1 Depoimentos 1/5 · carrossel com foto (1080×1350)."""
...
OUTPUT = "/home/user/out/c12-1.png"
...
TEXTOS = {
    ...
    'texto03': 'Depoimentos',  # 24px, texto, 800, claro, caixa alta automática, pílula
    'texto04': 'O que meus clientes dizem',  # 100px, título, 600, claro
    'texto05': 'Histórias reais, com permissão.',  # 34px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto03","content":[124,841.7,205.02,33],"pads":[14,28,14,28],"hug":True,"anchor":"left","maxW":832,"role":"body","size":24,"weight":800,"lineHeight":30,"tracking":2.88,"upper":True,"align":"left","lines":1,"bg":{"box":[96,827.7,261.02,61],"radius":30.5,"fill":["accent",1],"gradient":None,"borders":None},"style":{"color":["light",1]}},
