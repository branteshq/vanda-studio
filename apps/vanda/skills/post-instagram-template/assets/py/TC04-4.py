"""TC04-4 Checklist completo 4/5 · carrossel só texto (1080×1350)."""
...
OUTPUT = "/home/user/out/tc04-4.png"
...
TEXTOS = {
    ...
    'texto03': 'Parte 3',  # 26px, texto, 800, destaque, caixa alta automática
    'texto04': '[Nome da etapa 3]',  # 76px, título, 600, escuro
    'texto05': '[Item 3.1]',  # 34px, texto, 500, escuro
    'texto06': '[Item 3.2]',  # 34px, texto, 500, escuro
    'texto07': '[Item 3.3]',  # 34px, texto, 500, escuro
    'texto08': '[Item 3.4]',  # 34px, texto, 500, escuro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto03","content":[96,200,128.03,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    ...
    {"op":"text","key":"texto05","content":[186,422.27,143.56,46],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":768,"role":"body","size":34,"weight":500,"lineHeight":42.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    ...
    {"op":"text","key":"texto06","content":[186,538.27,153.5,46],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":768,"role":"body","size":34,"weight":500,"lineHeight":42.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    ...
    {"op":"text","key":"texto07","content":[186,654.27,152.95,46],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":768,"role":"body","size":34,"weight":500,"lineHeight":42.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    ...
    {"op":"text","key":"texto08","content":[186,770.27,154.09,46],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":768,"role":"body","size":34,"weight":500,"lineHeight":42.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
