"""C03-4 Mitos e verdades 4/5 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c03-4.png"
...
TEXTOS = {
    ...
    'texto03': 'Mito 3',  # 26px, texto, 800, neutro, caixa alta automática
    'texto04': '“[Crença errada 3.]”',  # 64px, título, 400, claro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[907.47,80,76.53,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.691",1]}},
    ...
    {"op":"text","key":"texto03","content":[152,174,108.03,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":832,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.613",1]}},
