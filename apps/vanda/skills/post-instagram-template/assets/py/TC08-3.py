"""TC08-3 Mini-aula 3/6 · carrossel só texto (1080×1350)."""
...
OUTPUT = "/home/user/out/tc08-3.png"
...
TEXTOS = {
    ...
    'texto02': '03/06',  # 26px, texto, 700, neutro
    'texto03': 'Parte 2',  # 26px, texto, 800, destaque, caixa alta automática
    'texto04': '[Conceito 2]',  # 80px, título, 600, claro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[907.23,88,76.77,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.691",1]}},
    {"op":"text","key":"texto03","content":[96,220,128.38,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
