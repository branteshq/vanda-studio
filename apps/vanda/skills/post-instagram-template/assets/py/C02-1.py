"""C02-1 Como funciona 1/5 · carrossel com foto (1080×1350)."""
...
OUTPUT = "/home/user/out/c02-1.png"
...
TEXTOS = {
    ...
    'texto03': 'Passo a passo',  # 24px, texto, 800, claro, caixa alta automática, pílula
    'texto04': 'Como funciona [seu serviço]',  # 100px, título, 600, claro
    'texto05': 'Do primeiro contato até o resultado.',  # 34px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto03","content":[124,841.7,225.58,33],"pads":[14,28,14,28],"hug":True,"anchor":"left","maxW":832,"role":"body","size":24,"weight":800,"lineHeight":30,"tracking":2.88,"upper":True,"align":"left","lines":1,"bg":{"box":[96,827.7,281.58,61],"radius":30.5,"fill":["accent",1],"gradient":None,"borders":None},"style":{"color":["light",1]}},
    {"op":"text","key":"texto04","content":[96,914.7,888,206],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":100,"weight":600,"lineHeight":103,"tracking":-2,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["light",1]}},
