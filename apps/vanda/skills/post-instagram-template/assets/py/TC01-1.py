"""TC01-1 Texto corrido (thread) 1/6 · carrossel só texto (1080×1350)."""
...
OUTPUT = "/home/user/out/tc01-1.png"
...
TEXTOS = {
    ...
    'texto03': 'Thread',  # 26px, texto, 800, destaque, caixa alta automática
    'texto04': '[Uma história ou reflexão sobre (tema)]',  # 100px, título, 600, escuro
    'texto05': 'Leia até o fim.',  # 34px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[910.97,88,73.03,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
