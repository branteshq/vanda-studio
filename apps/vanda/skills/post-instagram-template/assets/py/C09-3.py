"""C09-3 Lista de dicas 3/6 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c09-3.png"
...
TEXTOS = {
    ...
    'texto05': '[Dica 2]',  # 82px, título, 600, escuro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[907.23,88,76.77,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    ...
    {"op":"text","key":"texto04","content":[298.78,255.75,77.36,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":685.22,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
