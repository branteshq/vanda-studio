"""C09-2 Lista de dicas 2/6 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c09-2.png"
...
TEXTOS = {
    ...
    'texto04': 'Dica',  # 26px, texto, 800, destaque, caixa alta automática
    'texto05': '[Dica 1]',  # 82px, título, 600, escuro
    'texto06': '[Como aplicar no dia a dia.]',  # 36px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto04","content":[270.06,255.75,77.36,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":713.94,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
