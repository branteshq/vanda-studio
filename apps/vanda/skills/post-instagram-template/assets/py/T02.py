"""T02 Frase com destaque · post só texto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': '[Começo da frase] **[palavra-chave]** [fim da frase.]',  # 100px, título, 600, escuro, **trecho** = destaque
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[96,518.2,888,309],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":100,"weight":600,"lineHeight":103,"tracking":-2,"upper":False,"align":"left","lines":3,"bg":None,"style":{"color":["dark",1]},"emph":{"color":["dark",1],"highlight":["accent",1,0.22]}},
