"""S15 Pergunta que mais recebo · post único com foto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': 'Pergunta que eu mais recebo',  # 24px, texto, 800, claro, caixa alta automática, pílula
    'texto03': '“[A pergunta, do jeito que o cliente fala?]”',  # 88px, título, 600, claro
    'texto04': 'Resposta completa na legenda.',  # 34px, texto, 600, neutro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[124,940.45,462.84,33],"pads":[14,28,14,28],"hug":True,"anchor":"left","maxW":832,"role":"body","size":24,"weight":800,"lineHeight":30,"tracking":2.88,"upper":True,"align":"left","lines":1,"bg":{"box":[96,926.45,518.84,61],"radius":30.5,"fill":["accent",1],"gradient":None,"borders":None},"style":{"color":["light",1]}},
    {"op":"text","key":"texto03","content":[96,1013.45,888,181.25],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":88,"weight":600,"lineHeight":90.64,"tracking":-1.76,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto04","content":[96,1220.7,888,49.3],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":34,"weight":600,"lineHeight":49.3,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.912",1]}},
]
