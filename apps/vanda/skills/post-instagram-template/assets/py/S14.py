"""S14 Frase tipográfica · post único (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': '[Uma frase forte, **com uma palavra em destaque**, que o seu público vai querer compartilhar.]',  # 92px, título, 600, escuro, **trecho** = destaque
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[96,435.83,888,473.75],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":92,"weight":600,"lineHeight":94.76,"tracking":-1.84,"upper":False,"align":"left","lines":5,"bg":None,"style":{"color":["dark",1]},"emph":{"color":["accent",1],"italic":True}},
    {"op":"text","key":"texto03","content":[96,1221.41,888,40.59],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":28,"weight":700,"lineHeight":40.6,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
]
