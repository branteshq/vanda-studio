"""TC02-1 Glossário 1/5 · carrossel só texto (1080×1350)."""
...
OUTPUT = "/home/user/out/tc02-1.png"
...
TEXTOS = {
    ...
    'texto03': 'Glossário',  # 26px, texto, 800, neutro, caixa alta automática
    'texto04': 'Termos de [área] que todo cliente deveria entender',  # 100px, título, 600, claro
    'texto05': 'Sem juridiquês, sem mediquês.',  # 34px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto03","content":[96,697.7,888,36],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.941",1]}},
    {"op":"text","key":"texto04","content":[96,763.7,888,309],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":100,"weight":600,"lineHeight":103,"tracking":-2,"upper":False,"align":"left","lines":3,"bg":None,"style":{"color":["light",1]}},
