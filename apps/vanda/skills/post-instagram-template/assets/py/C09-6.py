"""C09-6 Lista de dicas 6/6 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c09-6.png"
...
TEXTOS = {
    ...
    'texto03': '05',  # 150px, título, 700, destaque
    'texto04': 'Dica',  # 26px, texto, 800, destaque, caixa alta automática
    'texto05': '[Dica 5]',  # 82px, título, 600, escuro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[906.2,88,77.8,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"text","key":"texto03","content":[96,210,178.14,127.5],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"title","size":150,"weight":700,"lineHeight":127.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto04","content":[294.14,255.75,77.36,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":689.86,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
