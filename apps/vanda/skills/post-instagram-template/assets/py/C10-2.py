"""C10-2 Antes e depois 2/4 · carrossel com foto (1080×1350)."""
...
OUTPUT = "/home/user/out/c10-2.png"
...
FOTOS = {
    'foto1': None,  # Antes · Foto do trabalho, não do profissional
}

# Textos de cima para baixo. Troque todo [colchete]; string vazia remove o elemento.
TEXTOS = {
    'texto01': 'Antes',  # 26px, texto, 800, destaque, caixa alta automática
    'texto02': '02/04',  # 26px, texto, 700, neutro
    'texto03': '[Como estava e qual era a queixa.]',  # 36px, texto, 500, escuro
    'texto04': 'Arraste',  # 28px, texto, 700, escuro
}

LAYOUT = [
    {"op":"box","box":[0,0,1080,1350],"radius":0,"fill":["light",1],"gradient":None,"borders":None},
    {"op":"photo","key":"foto1","box":[0,0,1080,860],"radius":0,"label":["Antes","Foto do trabalho, não do profissional"]},
    {"op":"text","key":"texto01","content":[96,916,103.56,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto02","content":[907.22,916,76.78,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
