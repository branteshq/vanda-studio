"""S19 Evento ou palestra · post único com foto (1080×1350)."""
...
# Caminho da foto de cada área em /home/user/ (veja /home/user/meta.json). None desenha a área de referência.
FOTOS = {
    'foto1': None,  # Foto do profissional ao fundo · Retrato corporativo em sangria total (1080×1350). Rosto no terço superior, deixar a parte de baixo livre para o texto.
}

# Textos de cima para baixo. Troque todo [colchete]; string vazia remove o elemento.
TEXTOS = {
    'texto01': '@[seuperfil]',  # 26px, texto, 600, neutro
    'texto02': 'Evento',  # 24px, texto, 800, claro, caixa alta automática, pílula
    'texto03': '[Nome da palestra ou evento]',  # 96px, título, 600, claro
    'texto04': '[Data] · [Horário]',  # 32px, texto, 600, neutro
    'texto05': '[Local ou link]',  # 32px, texto, 600, neutro
    'texto06': 'Inscrições no link da bio',  # 32px, texto, 800, claro
}

LAYOUT = [
    {"op":"box","box":[0,0,1080,1350],"radius":0,"fill":["light",1],"gradient":None,"borders":None},
    {"op":"photo","key":"foto1","box":[0,0,1080,1350],"radius":0,"label":["Foto do profissional ao fundo","Retrato corporativo em sangria total (1080×1350). Rosto no terço superior, deixar a parte de baixo livre para o texto."]},
    {"op":"box","box":[0,590,1080,760],"radius":0,"fill":None,"gradient":{"dir":"to top","stops":[["dark",0.94,0],["dark",0.78,0.45],["dark",0,1]]},"borders":None},
    {"op":"text","key":"texto01","content":[96,80,154.95,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":26,"weight":600,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.941",1]}},
    {"op":"text","key":"texto02","content":[124,739.25,111.61,33],"pads":[14,28,14,28],"hug":True,"anchor":"left","maxW":832,"role":"body","size":24,"weight":800,"lineHeight":30,"tracking":2.88,"upper":True,"align":"left","lines":1,"bg":{"box":[96,725.25,167.61,61],"radius":30.5,"fill":["accent",1],"gradient":None,"borders":None},"style":{"color":["light",1]}},
    {"op":"text","key":"texto03","content":[96,812.25,888,197.75],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":96,"weight":600,"lineHeight":98.88,"tracking":-1.92,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["light",1]}},
    {"op":"icon","strokes":[{"parts":[[[103.5,1047.5],[124.5,1047.5],[125.5,1047.7],[126.5,1048.3],[127.2,1049.2],[127.4,1069.3],[126.9,1070.3],[126.1,1071.1],[125,1071.5],[103,1071.5],[102,1071.1],[101.1,1070.3],[100.6,1069.3],[100.5,1050.3],[100.8,1049.2],[101.5,1048.3],[102.5,1047.7],[103.5,1047.5]]],"stroke":["mix:0.941",1],"fill":None,"width":3},{"parts":[[[100.5,1055],[127.5,1055]]],"stroke":["mix:0.941",1],"fill":None,"width":3},{"parts":[[[108,1044.5],[108,1050.5]]],"stroke":["mix:0.941",1],"fill":None,"width":3},{"parts":[[[120,1044.5],[120,1050.5]]],"stroke":["mix:0.941",1],"fill":None,"width":3}]},
    {"op":"text","key":"texto04","content":[148,1036,257.22,44],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":836,"role":"body","size":32,"weight":600,"lineHeight":40,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.941",1]}},
    {"op":"icon","strokes":[{"parts":[[[114,1131.5],[121.6,1122.3],[124,1116.9],[124.5,1112.9],[123.5,1109.1],[121.2,1105.9],[117.9,1103.7],[114,1103],[110.1,1103.7],[106.8,1105.9],[104.5,1109.1],[103.5,1112.9],[104.3,1117.8],[109.9,1127.2],[114,1131.5]]],"stroke":["mix:0.941",1],"fill":None,"width":3},{"parts":[[[117.8,1113.5],[117.2,1115.4],[116.6,1116.3],[114.7,1117.2],[112.8,1117.1],[111.9,1116.6],[110.5,1114.9],[110.3,1113],[111.1,1111.2],[111.9,1110.4],[113.8,1109.8],[115.7,1110.2],[116.6,1110.8],[117.6,1112.5],[117.8,1113.5]]],"stroke":["mix:0.941",1],"fill":None,"width":3}]},
    {"op":"text","key":"texto05","content":[148,1096,213.11,44],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":836,"role":"body","size":32,"weight":600,"lineHeight":40,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.941",1]}},
    {"op":"box","box":[96,1166,888,104],"radius":20,"fill":["accent",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto06","content":[132,1196,374.67,44],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":816,"role":"body","size":32,"weight":800,"lineHeight":40,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    {"op":"icon","strokes":[{"parts":[[[919.5,1218],[940.5,1218]]],"stroke":["light",1],"fill":None,"width":3},{"parts":[[[931.5,1209],[940.5,1218],[931.5,1227]]],"stroke":["light",1],"fill":None,"width":3}]},
]
