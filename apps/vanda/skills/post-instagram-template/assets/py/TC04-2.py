"""TC04-2 Checklist completo 2/5 · carrossel só texto (1080×1350)."""
...
OUTPUT = "/home/user/out/tc04-2.png"
...
TEXTOS = {
    ...
    'texto02': '02/05',  # 26px, texto, 700, neutro
    'texto03': 'Parte 1',  # 26px, texto, 800, destaque, caixa alta automática
    'texto04': '[Nome da etapa 1]',  # 76px, título, 600, escuro
    'texto05': '[Item 1.1]',  # 34px, texto, 500, escuro
    'texto06': '[Item 1.2]',  # 34px, texto, 500, escuro
    'texto07': '[Item 1.3]',  # 34px, texto, 500, escuro
    'texto08': '[Item 1.4]',  # 34px, texto, 500, escuro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[907.8,88,76.2,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"text","key":"texto03","content":[96,200,124.47,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    ...
    {"op":"text","key":"texto05","content":[186,422.27,136.88,46],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":768,"role":"body","size":34,"weight":500,"lineHeight":42.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    ...
    {"op":"text","key":"texto06","content":[186,538.27,146.81,46],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":768,"role":"body","size":34,"weight":500,"lineHeight":42.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    ...
    {"op":"text","key":"texto07","content":[186,654.27,146.28,46],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":768,"role":"body","size":34,"weight":500,"lineHeight":42.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    ...
    {"op":"text","key":"texto08","content":[186,770.27,147.42,46],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":768,"role":"body","size":34,"weight":500,"lineHeight":42.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
