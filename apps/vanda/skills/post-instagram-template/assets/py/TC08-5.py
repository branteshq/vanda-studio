"""TC08-5 Mini-aula 5/6 · carrossel só texto (1080×1350)."""
...
OUTPUT = "/home/user/out/tc08-5.png"
...
TEXTOS = {
    ...
    'texto02': '05/06',  # 26px, texto, 700, neutro
    'texto03': 'Parte 4',  # 26px, texto, 800, destaque, caixa alta automática
    'texto04': '[Conceito 4]',  # 80px, título, 600, claro
    'texto05': '[Explicação didática em três frases curtas. Pense numa mini-aula.]',  # 38px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[907.13,88,76.88,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.691",1]}},
    {"op":"text","key":"texto03","content":[96,220,128.66,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto04","content":[96,292,888,82.39],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":80,"weight":600,"lineHeight":82.4,"tracking":-1.6,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto05","content":[96,410.39,888,110.19],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":38,"weight":400,"lineHeight":55.1,"tracking":0,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["mix:0.814",1]}},
