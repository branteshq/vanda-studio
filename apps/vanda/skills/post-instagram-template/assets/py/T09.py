"""T09 Passo a passo em um post · post só texto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': 'Como fazer',  # 26px, texto, 800, destaque, caixa alta automática
    'texto03': '[Como (resolver algo) em 3 passos]',  # 80px, título, 600, escuro
    'texto04': '1',  # 44px, título, 700, claro
    'texto05': '[Passo 1]',  # 36px, texto, 800, escuro
    'texto06': '[Detalhe curto]',  # 28px, texto, 400, neutro
    'texto07': '2',  # 44px, título, 700, claro
    'texto08': '[Passo 2]',  # 36px, texto, 800, escuro
    'texto09': '[Detalhe curto]',  # 28px, texto, 400, neutro
    'texto10': '3',  # 44px, título, 700, claro
    'texto11': '[Passo 3]',  # 36px, texto, 800, escuro
    'texto12': '[Detalhe curto]',  # 28px, texto, 400, neutro
    'texto13': 'Salve para lembrar depois',  # 28px, texto, 700, escuro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto03","content":[96,232,888,164.78],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":80,"weight":600,"lineHeight":82.4,"tracking":-1.6,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["dark",1]}},
    {"op":"box","box":[96,452.78,888,151],"radius":24,"fill":["card",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto04","content":[130,486.28,84,84],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":84,"role":"title","size":44,"weight":700,"lineHeight":55,"tracking":0,"upper":False,"align":"left","lines":1,"bg":{"box":[130,486.28,84,84],"radius":42,"fill":["accent",1],"gradient":None,"borders":None},"style":{"color":["light",1]}},
    {"op":"text","key":"texto05","content":[242,482.78,198.19,49],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":198.19,"role":"body","size":36,"weight":800,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto06","content":[242,535.78,198.19,38],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":198.19,"role":"body","size":28,"weight":400,"lineHeight":35,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"box","box":[96,625.78,888,151],"radius":24,"fill":["card",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto07","content":[130,659.28,84,84],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":84,"role":"title","size":44,"weight":700,"lineHeight":55,"tracking":0,"upper":False,"align":"left","lines":1,"bg":{"box":[130,659.28,84,84],"radius":42,"fill":["accent",1],"gradient":None,"borders":None},"style":{"color":["light",1]}},
    {"op":"text","key":"texto08","content":[242,655.78,198.19,49],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":198.19,"role":"body","size":36,"weight":800,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto09","content":[242,708.78,198.19,38],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":198.19,"role":"body","size":28,"weight":400,"lineHeight":35,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"box","box":[96,798.78,888,151],"radius":24,"fill":["card",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto10","content":[130,832.28,84,84],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":84,"role":"title","size":44,"weight":700,"lineHeight":55,"tracking":0,"upper":False,"align":"left","lines":1,"bg":{"box":[130,832.28,84,84],"radius":42,"fill":["accent",1],"gradient":None,"borders":None},"style":{"color":["light",1]}},
    {"op":"text","key":"texto11","content":[242,828.78,198.19,49],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":198.19,"role":"body","size":36,"weight":800,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto12","content":[242,881.78,198.19,38],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":198.19,"role":"body","size":28,"weight":400,"lineHeight":35,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"icon","strokes":[{"parts":[[[104.5,1230.3],[121.4,1230.3],[121.5,1255],[121.3,1255.6],[113.1,1250.1],[104.8,1255.6],[104.5,1255.1],[104.5,1230.3]]],"stroke":["dark",1],"fill":None,"width":2.83}]},
    {"op":"text","key":"texto13","content":[144,1224,347.42,38],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":840,"role":"body","size":28,"weight":700,"lineHeight":35,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
]
