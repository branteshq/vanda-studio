"""C07-3 Sobre mim 3/5 · carrossel (1080×1350)."""
...
OUTPUT = "/home/user/out/c07-3.png"
...
TEXTOS = {
    ...
    'texto04': 'Formação',  # 26px, texto, 800, destaque, caixa alta automática
    'texto05': '[Graduação e especializações]',  # 82px, título, 600, escuro
    'texto06': '[Instituições e anos.]',  # 36px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto04","content":[298.78,255.75,175.45,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":685.22,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
