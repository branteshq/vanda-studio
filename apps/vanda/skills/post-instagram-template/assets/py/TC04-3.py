"""TC04-3 Checklist completo 3/5 · carrossel só texto (1080×1350)."""
...
OUTPUT = "/home/user/out/tc04-3.png"
...
TEXTOS = {
    ...
    'texto02': '03/05',  # 26px, texto, 700, neutro
    'texto03': 'Parte 2',  # 26px, texto, 800, destaque, caixa alta automática
    'texto04': '[Nome da etapa 2]',  # 76px, título, 600, escuro
    'texto05': '[Item 2.1]',  # 34px, texto, 500, escuro
    'texto06': '[Item 2.2]',  # 34px, texto, 500, escuro
    'texto07': '[Item 2.3]',  # 34px, texto, 500, escuro
    'texto08': '[Item 2.4]',  # 34px, texto, 500, escuro
    'texto09': 'Arraste',  # 28px, texto, 700, escuro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[908.16,88,75.84,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"text","key":"texto03","content":[96,200,128.38,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto04","content":[96,272,888,78.27],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":76,"weight":600,"lineHeight":78.28,"tracking":-1.52,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"box","box":[96,396.27,888,98],"radius":20,"fill":["card",1],"gradient":None,"borders":None},
    {"op":"icon","strokes":[{"parts":[[[132.7,446.1],[141.1,454.3],[159.3,436.1]]],"stroke":["accent",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto05","content":[186,422.27,144.09,46],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":768,"role":"body","size":34,"weight":500,"lineHeight":42.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"box","box":[96,512.27,888,98],"radius":20,"fill":["card",1],"gradient":None,"borders":None},
    {"op":"icon","strokes":[{"parts":[[[132.7,562.1],[141.1,570.3],[159.3,552.1]]],"stroke":["accent",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto06","content":[186,538.27,154.05,46],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":768,"role":"body","size":34,"weight":500,"lineHeight":42.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"box","box":[96,628.27,888,98],"radius":20,"fill":["card",1],"gradient":None,"borders":None},
    {"op":"icon","strokes":[{"parts":[[[132.7,678.1],[141.1,686.3],[159.3,668.1]]],"stroke":["accent",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto07","content":[186,654.27,153.5,46],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":768,"role":"body","size":34,"weight":500,"lineHeight":42.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"box","box":[96,744.27,888,98],"radius":20,"fill":["card",1],"gradient":None,"borders":None},
    {"op":"icon","strokes":[{"parts":[[[132.7,794.1],[141.1,802.3],[159.3,784.1]]],"stroke":["accent",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto08","content":[186,770.27,154.64,46],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":768,"role":"body","size":34,"weight":500,"lineHeight":42.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto09","content":[835.72,1224,100.28,38],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":840,"role":"body","size":28,"weight":700,"lineHeight":35,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
