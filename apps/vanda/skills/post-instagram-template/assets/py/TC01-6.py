"""TC01-6 Texto corrido (thread) 6/6 · carrossel só texto (1080×1350)."""
...
OUTPUT = "/home/user/out/tc01-6.png"
...
TEXTOS = {
    ...
    'texto02': '06/06',  # 26px, texto, 700, neutro
    'texto03': 'Fez sentido para você?',  # 104px, título, 600, claro
    'texto04': 'Me conta nos comentários.',  # 38px, texto, 400, neutro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[906.2,88,77.8,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.691",1]}},
    {"op":"box","box":[96,280,120,8],"radius":0,"fill":["accent",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto03","content":[96,324,888,107.11],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":104,"weight":600,"lineHeight":107.12,"tracking":-2.08,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto04","content":[96,467.11,888,55.09],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":38,"weight":400,"lineHeight":55.1,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.814",1]}},
