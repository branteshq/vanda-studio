"""T19 Horário de atendimento · post só texto (1080×1350)."""
...
TEXTOS = {
    ...
    'texto02': 'Atendimento',  # 26px, texto, 800, destaque, caixa alta automática
    'texto03': 'Horários de [mês ou semana]',  # 88px, título, 600, escuro
    'texto04': 'Segunda',  # 36px, texto, 700, escuro
    'texto05': '[00h às 00h]',  # 36px, texto, 400, neutro
    'texto06': 'Terça',  # 36px, texto, 700, escuro
    'texto07': '[00h às 00h]',  # 36px, texto, 400, neutro
    'texto08': 'Quarta',  # 36px, texto, 700, escuro
    'texto09': '[00h às 00h]',  # 36px, texto, 400, neutro
    'texto10': 'Quinta',  # 36px, texto, 700, escuro
    'texto11': '[00h às 00h]',  # 36px, texto, 400, neutro
    'texto12': 'Sexta',  # 36px, texto, 700, escuro
    'texto13': '[00h às 00h]',  # 36px, texto, 400, neutro
    'texto14': 'Sábado',  # 36px, texto, 700, escuro
    'texto15': '[00h às 00h]',  # 36px, texto, 400, neutro
    'texto16': 'Agende pelo link na bio',  # 32px, texto, 800, claro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[96,160,888,36],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto03","content":[96,232,888,181.25],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":88,"weight":600,"lineHeight":90.64,"tracking":-1.76,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["dark",1]}},
    {"op":"box","box":[96,469.25,888,102],"radius":0,"fill":None,"gradient":None,"borders":{"t":[1,"solid",["mix:0.853",1]]}},
    {"op":"text","key":"texto04","content":[96,496.25,155.2,49],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":36,"weight":700,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto05","content":[771.5,496.25,212.5,49],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":36,"weight":400,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"box","box":[96,571.25,888,102],"radius":0,"fill":None,"gradient":None,"borders":{"t":[1,"solid",["mix:0.853",1]]}},
    {"op":"text","key":"texto06","content":[96,598.25,95.8,49],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":36,"weight":700,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto07","content":[771.5,598.25,212.5,49],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":36,"weight":400,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"box","box":[96,673.25,888,102],"radius":0,"fill":None,"gradient":None,"borders":{"t":[1,"solid",["mix:0.853",1]]}},
    {"op":"text","key":"texto08","content":[96,700.25,120.94,49],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":36,"weight":700,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto09","content":[771.5,700.25,212.5,49],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":36,"weight":400,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"box","box":[96,775.25,888,102],"radius":0,"fill":None,"gradient":None,"borders":{"t":[1,"solid",["mix:0.853",1]]}},
    {"op":"text","key":"texto10","content":[96,802.25,118.45,49],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":36,"weight":700,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto11","content":[771.5,802.25,212.5,49],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":36,"weight":400,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"box","box":[96,877.25,888,102],"radius":0,"fill":None,"gradient":None,"borders":{"t":[1,"solid",["mix:0.853",1]]}},
    {"op":"text","key":"texto12","content":[96,904.25,100.89,49],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":36,"weight":700,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto13","content":[771.5,904.25,212.5,49],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":36,"weight":400,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"box","box":[96,979.25,888,102],"radius":0,"fill":None,"gradient":None,"borders":{"t":[1,"solid",["mix:0.853",1]]}},
    {"op":"text","key":"texto14","content":[96,1006.25,131.78,49],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":888,"role":"body","size":36,"weight":700,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["dark",1]}},
    {"op":"text","key":"texto15","content":[771.5,1006.25,212.5,49],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":36,"weight":400,"lineHeight":45,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.265",1]}},
    {"op":"box","box":[96,1158,888,104],"radius":20,"fill":["accent",1],"gradient":None,"borders":None},
    {"op":"text","key":"texto16","content":[132,1188,360.33,44],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":816,"role":"body","size":32,"weight":800,"lineHeight":40,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    {"op":"icon","strokes":[{"parts":[[[919.5,1210],[940.5,1210]]],"stroke":["light",1],"fill":None,"width":3},{"parts":[[[931.5,1201],[940.5,1210],[931.5,1219]]],"stroke":["light",1],"fill":None,"width":3}]},
]
