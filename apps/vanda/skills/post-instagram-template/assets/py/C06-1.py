"""C06-1 Estudo de caso 1/5 · carrossel com foto (1080×1350)."""
...
OUTPUT = "/home/user/out/c06-1.png"
...
TEXTOS = {
    ...
    'texto02': '01/05',  # 26px, texto, 700, neutro
    'texto03': 'Caso real',  # 24px, texto, 800, claro, caixa alta automática, pílula
    'texto04': 'Como [cliente ou perfil de cliente] resolveu [problema]',  # 100px, título, 600, claro
    'texto05': 'Com autorização do cliente.',  # 34px, texto, 400, neutro
    'texto06': 'Arraste',  # 28px, texto, 700, claro
}
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[911.89,80,72.11,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.941",1]}},
    {"op":"text","key":"texto03","content":[124,738.7,157.98,33],"pads":[14,28,14,28],"hug":True,"anchor":"left","maxW":832,"role":"body","size":24,"weight":800,"lineHeight":30,"tracking":2.88,"upper":True,"align":"left","lines":1,"bg":{"box":[96,724.7,213.98,61],"radius":30.5,"fill":["accent",1],"gradient":None,"borders":None},"style":{"color":["light",1]}},
    {"op":"text","key":"texto04","content":[96,811.7,888,309],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":100,"weight":600,"lineHeight":103,"tracking":-2,"upper":False,"align":"left","lines":3,"bg":None,"style":{"color":["light",1]}},
    {"op":"text","key":"texto05","content":[96,1146.7,888,49.3],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":34,"weight":400,"lineHeight":49.3,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.912",1]}},
    {"op":"text","key":"texto06","content":[835.72,1232,100.28,38],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":840,"role":"body","size":28,"weight":700,"lineHeight":35,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["light",1]}},
    {"op":"icon","strokes":[{"parts":[[[955.5,1251],[976.5,1251]]],"stroke":["light",1],"fill":None,"width":3},{"parts":[[[967.5,1242],[976.5,1251],[967.5,1260]]],"stroke":["light",1],"fill":None,"width":3}]},
]
