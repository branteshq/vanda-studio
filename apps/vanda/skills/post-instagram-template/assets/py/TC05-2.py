"""TC05-2 O que ninguém te conta 2/5 · carrossel só texto (1080×1350)."""
...
OUTPUT = "/home/user/out/tc05-2.png"
...
TEXTOS = {
    ...
    'texto03': '01',  # 140px, título, 700, destaque
    'texto04': '[Verdade 1 que ninguém te conta]',  # 84px, título, 600, claro
...
LAYOUT = [
    ...
    {"op":"text","key":"texto02","content":[907.8,88,76.2,36],"pads":[0,0,0,0],"hug":True,"anchor":"right","maxW":888,"role":"body","size":26,"weight":700,"lineHeight":32.5,"tracking":0,"upper":False,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.691",1]}},
