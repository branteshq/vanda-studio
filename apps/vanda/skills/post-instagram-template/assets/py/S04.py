"""S04 Mito x verdade · post único (1080×1350)."""
...
TEXTOS = {
    'texto01': 'Mito',  # 26px, texto, 800, neutro, caixa alta automática
    'texto02': '“[A crença errada que seu público repete.]”',  # 68px, título, 400, claro
    'texto03': 'Verdade',  # 26px, texto, 800, destaque, caixa alta automática
    'texto04': '[O que realmente acontece, explicado em linguagem simples.]',  # 44px, texto, 500, escuro
    'texto05': '@[seuperfil]',  # 26px, texto, 600, neutro
}

LAYOUT = [
    {"op":"box","box":[0,0,1080,1350],"radius":0,"fill":["light",1],"gradient":None,"borders":None},
    {"op":"box","box":[0,0,1080,675],"radius":0,"fill":["dark",1],"gradient":None,"borders":None},
    {"op":"icon","strokes":[{"parts":[[[106,98],[126,118]]],"stroke":["mix:0.363",1],"fill":None,"width":4},{"parts":[[[126,98],[106,118]]],"stroke":["mix:0.363",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto01","content":[152,90,80.19,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":832,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["mix:0.613",1]}},
    {"op":"text","key":"texto02","content":[96,156,888,152.31],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"title","size":68,"weight":400,"lineHeight":76.16,"tracking":0,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["light",1]}},
    {"op":"icon","strokes":[{"parts":[[[102.7,783.8],[111.1,792.1],[129.3,773.8]]],"stroke":["accent",1],"fill":None,"width":4}]},
    {"op":"text","key":"texto03","content":[152,765,144.72,36],"pads":[0,0,0,0],"hug":True,"anchor":"left","maxW":832,"role":"body","size":26,"weight":800,"lineHeight":32.5,"tracking":3.64,"upper":True,"align":"left","lines":1,"bg":None,"style":{"color":["accent",1]}},
    {"op":"text","key":"texto04","content":[96,831,888,127.59],"pads":[0,0,0,0],"hug":False,"anchor":"left","maxW":888,"role":"body","size":44,"weight":500,"lineHeight":63.8,"tracking":0,"upper":False,"align":"left","lines":2,"bg":None,"style":{"color":["dark",1]}},
