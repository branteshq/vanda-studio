...
function SidebarProvider({
  ...
  // SAFETY: the asserted object contains only valid CSS custom properties.
  return (
        ...
        style={
          {
            ...
            "--sidebar-width-icon-padded": "calc(var(--sidebar-width-icon) + 1rem)",
            "--sidebar-width-icon-floating": "calc(var(--sidebar-width-icon) + 1rem + 2px)",
            ...style,
...
function Sidebar({
  ...
  if (isMobile) {
    // SAFETY: the asserted object contains only a valid CSS custom property.
    return (
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ? "group-data-[collapsible=icon]:w-(--sidebar-width-icon-padded)"
      ...
      <div
        ...
        data-side={side}
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-all duration-200 ease-linear data-[side=left]:left-0 data-[side=left]:group-data-[collapsible=offcanvas]:-left-(--sidebar-width) data-[side=right]:right-0 data-[side=right]:group-data-[collapsible=offcanvas]:-right-(--sidebar-width) md:flex",
  ...
  return (
    ...
    >
      <span
        aria-hidden
        className={cn(
          "pointer-events-none absolute inset-y-0 left-1/2 w-0.5 -translate-x-1/2 rounded-full bg-sidebar-ring transition-opacity duration-150 ease-out motion-reduce:transition-none",
          resizing
            ? "opacity-100"
  ...
  return (
    <div
      ...
      className={cn(
        ...
        divider && "border-b border-sidebar-border",
        className,
      )}
      {...props}
    />
...
function SidebarGroupAction({
  ...
  return useRender({
    ...
    props: mergeProps<"button">(
      {
        className: cn(
          "absolute top-3.5 right-3 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground ring-sidebar-ring outline-hidden transition duration-150 ease-out group-data-[collapsible=icon]:hidden after:absolute after:-inset-2 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 md:after:hidden [&>svg]:size-4 [&>svg]:shrink-0",
          className,
        ),
      },
      props,
  ...
  "peer/menu-button group/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm ring-sidebar-ring outline-hidden transition-all duration-150 ease-out group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground data-active:bg-sidebar-accent data-active:font-medium data-active:text-sidebar-accent-foreground [&_svg]:size-4 [&_svg]:shrink-0 [&>span:last-child]:truncate",
  {
    variants: {
      variant: {
        ...
        "primary-soft":
          "border border-sidebar-primary-soft-border bg-sidebar-primary-soft text-sidebar-foreground hover:bg-sidebar-primary-soft hover:brightness-110 active:bg-sidebar-primary-soft",
      },
      size: {
        default: "h-8 text-sm",
        sm: "h-7 text-xs",
        ...
        action:
          "h-11 gap-2.5 px-3 text-body font-semibold group-data-[collapsible=icon]:gap-0! group-data-[collapsible=icon]:px-0!",
        post: "h-auto gap-2.5 py-2",
        navigation: "h-10 gap-2.5 px-3 text-body font-semibold",
      },
    },
    defaultVariants: {
      variant: "default",
...
function SidebarMenuAction({
  ...
  return useRender({
    ...
    props: mergeProps<"button">(
      {
        className: cn(
          "absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground ring-sidebar-ring outline-hidden transition duration-150 ease-out group-data-[collapsible=icon]:hidden peer-hover/menu-button:text-sidebar-accent-foreground peer-data-[size=default]/menu-button:top-1.5 peer-data-[size=lg]/menu-button:top-2.5 peer-data-[size=sm]/menu-button:top-1 after:absolute after:-inset-2 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 md:after:hidden [&>svg]:size-4 [&>svg]:shrink-0",
          showOnHover &&
