    ...
    <TooltipPrimitive.Portal>
      ...
      >
        <TooltipPrimitive.Popup
          ...
          className={cn(
            "z-50 inline-flex w-fit max-w-xs origin-(--transform-origin) items-center gap-1.5 rounded-md border border-border-strong bg-popover px-2.5 py-1.5 text-xs font-medium text-popover-foreground shadow-md transition duration-200 ease-out has-data-[slot=kbd]:pr-1.5 data-[instant=delay]:duration-100 data-ending-style:scale-98 data-ending-style:opacity-0 data-ending-style:duration-100 data-starting-style:scale-96 data-starting-style:opacity-0 data-[side=bottom]:data-ending-style:-translate-y-1 data-[side=bottom]:data-starting-style:-translate-y-1.5 data-[side=inline-end]:data-ending-style:-translate-x-1 data-[side=inline-end]:data-starting-style:-translate-x-1.5 data-[side=inline-start]:data-ending-style:translate-x-1 data-[side=inline-start]:data-starting-style:translate-x-1.5 data-[side=left]:data-ending-style:translate-x-1 data-[side=left]:data-starting-style:translate-x-1.5 data-[side=right]:data-ending-style:-translate-x-1 data-[side=right]:data-starting-style:-translate-x-1.5 data-[side=top]:data-ending-style:translate-y-1 data-[side=top]:data-starting-style:translate-y-1.5 motion-reduce:transform-none motion-reduce:transition-opacity **:data-[slot=kbd]:relative **:data-[slot=kbd]:isolate **:data-[slot=kbd]:z-50 **:data-[slot=kbd]:rounded-sm",
            className,
          )}
          {...props}
        >
          {children}
          <TooltipPrimitive.Arrow className="z-50 size-2.5 -translate-y-3/4 rotate-45 rounded-xs bg-popover fill-popover data-[side=bottom]:top-1 data-[side=inline-end]:top-1/2! data-[side=inline-end]:-left-1 data-[side=inline-end]:-translate-y-1/2 data-[side=inline-start]:top-1/2! data-[side=inline-start]:-right-1 data-[side=inline-start]:-translate-y-1/2 data-[side=left]:top-1/2! data-[side=left]:-right-1 data-[side=left]:-translate-y-1/2 data-[side=right]:top-1/2! data-[side=right]:-left-1 data-[side=right]:-translate-y-1/2 data-[side=top]:-bottom-2.5" />
        </TooltipPrimitive.Popup>
      </TooltipPrimitive.Positioner>
    </TooltipPrimitive.Portal>
  );
