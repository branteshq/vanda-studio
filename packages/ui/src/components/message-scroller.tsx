...
function MessageScrollerViewport({
  ...
  return (
    <MessageScrollerPrimitive.Viewport
      ...
      className={cn(
        "size-full min-h-0 min-w-0 scrollbar-thin scrollbar-stable overflow-y-auto overscroll-contain contain-content",
        className,
      )}
      {...props}
    />
...
function MessageScrollerItem({
  ...
  return (
    <MessageScrollerPrimitive.Item
      ...
      className={cn("min-w-0 shrink-0 content-auto", className)}
      {...props}
    />
  );
}
